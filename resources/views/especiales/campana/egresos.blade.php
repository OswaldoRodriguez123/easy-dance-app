    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form name="form_agregar" id="form_agregar"  >
                ...
                <input type="hidden" id="campana_id" name="campana_id" value="{{$campana->id}}">
...
<script type="text/javascript">
    ...
    route_agregar="{{url('/')}}/especiales/campañas/agregar-egreso";
    route_eliminar="{{url('/')}}/especiales/campañas/eliminar-egreso/";
