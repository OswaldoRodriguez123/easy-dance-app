                         ...
                         <div class="col-sm-3">
                              ...
                              <div class="col-sm-9">
                               ...
                               <div class="col-sm-offset-1 col-sm-6" >
          					        <div class="text-center">
          					           <!-- <img src="{{url('/')}}/assets/uploads/clase_grupal/{{$clase_grupal->imagen}}" class="img-responsive opaco-0-8" width="700" alt=""> -->
                               <img src="{{url('/')}}/assets/uploads/clase_grupal/{{$clase_grupal->imagen}}" class="opaco-0-8" height = "400px" width="700px" alt="">
          					        </div>
          					    </div>
