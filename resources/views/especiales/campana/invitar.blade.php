                ...
                <div class="container">
                    <div class="card">
                        ...
                        <div class="col-md-1"></div>
                            ...
                            <div class="f-700 f-30 text-center">Háblales a tus amigos de la campaña y así también puedes contribuir</div>
...
@section('js') 
    ...
    <script type="text/javascript">
            ...
            route_enviar="{{url('/')}}/especiales/campañas/invitar";
            route_agregar="{{url('/')}}/especiales/campañas/invitar/agregar";
            route_eliminar="{{url('/')}}/especiales/campañas/invitar/eliminar";
            route_enhorabuena="{{url('/')}}/especiales/campañas/invitacion/enhorabuena/";
