                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-b-20">
                          <form name="agregar_regalo" id="agregar_regalo"  >
                           ...
                           <input type="hidden" name="id" value="{{ $regalo->id }}">
                            <div class="row p-l-10 p-r-10">
                            <hr>
                            <div class="clearfix p-b-15"></div>
                            ...
                            <div class="clearfix p-b-15"></div>
                                <div class="col-sm-12">
                                     ...
                                     <label for="alumno" id="id-alumno_id">De parte de</label> <span class="c-morado f-700 f-16">*</span> <i class="p-l-5 tm-icon zmdi zmdi-help ayuda mousedefault" data-trigger="hover" data-toggle="popover" data-placement="right" data-content="Selecciona el participante que va a dar el regalo" title="" data-original-title="Ayuda"></i>
...
<script type="text/javascript">
  ...
  route_agregar="{{url('/')}}/especiales/regalos/enviar";
  ...
  setInterval(porcentaje, 1000);
   ...
   function porcentaje(){
    var campo = ["dirigido_a", "correo", "alumno_id"];
    fLen = campo.length;
    var porcetaje=0;
    var cantidad =0;
  ...
  $("#verificar").click(function(){
                ...
                var route = route_verificar + $("#alumno_id").val();
    ...
    function errores(merror){
      ...
      $('html,body').animate({
       ...
       $( "#cancelar" ).click(function() {
        ...
        limpiarMensaje();
        $('html,body').animate({
        scrollTop: $("#id-dirigido_a").offset().top-90,
        }, 800);
        document.getElementById("dirigido_a").focus();
      });

    $('#modalAgregar').on('show.bs.modal', function (event) {

      alumno_id = $("#alumno_id").val();
      expresion = "#alumno_id option[value="+alumno_id+"]";
      texto = $(expresion).text();
      nombre = "{{$regalo->nombre}}";
      costo = "{{$regalo->costo}}";
      $("#span_item").text(nombre); 
      $("#span_precio").text(costo);
