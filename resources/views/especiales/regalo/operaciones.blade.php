           ...
           <div class="block-header">
            ...
            <ul class="ca-menu-c " style="width: 720px;">
                    ...
                    <li data-ripplecator class ="dark-ripples">
                        <a href="{{url('/')}}/especiales/regalos/enviar/{{$regalo->id}}">
                            <span class="ca-icon-c"><i class="icon_a-participantes f-35 boton blue sa-warning" 
                                   data-original-title="Agregar participante" data-toggle="tooltip" data-placement="bottom" title=""></i></span>
                            <div class="ca-content-c">
                                <h2 class="ca-main-c">Agregar participante</h2>
