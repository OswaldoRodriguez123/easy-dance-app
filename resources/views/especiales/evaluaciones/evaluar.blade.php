        ...
        <div class="card-header ch-alt text-center">
            ...
            <div class="row m-b-25">
             ...
             <div class="col-sm-12">
                  ...
                  <textarea class="form-control caja" style="height:100%" id="observacion" name="observacion" rows="8" placeholder="2000 Caracteres" maxlength="2000" onkeyup="countChar(this)">{{$evaluacion->observacion}}</textarea>
