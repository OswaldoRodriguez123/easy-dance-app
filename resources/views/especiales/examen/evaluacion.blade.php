            ...
            <section id="content">
                <div class="container">
                    ...
                    <div class="block-header">
                        <a class="btn-blanco m-r-10 f-16" href="{{url('/')}}/especiales/promociones"> <i class="zmdi zmdi-chevron-left zmdi-hc-fw"></i> Inicio</a>
...
<script type="text/javascript">
  ...
  function porcentaje(){
      var campo = ["nombre", "porcentaje_descuento", "descripcion", "fecha_desde", "fecha_hasta", "imagen", "edad_desde", "edad_hasta"];
    fLen = campo.length;
    var porcetaje=0;
    var cantidad =0;
