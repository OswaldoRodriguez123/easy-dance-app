            ...
            <ul class="ca-menu-c col-sm-5" style="width: 720px;">
                    ...
                    <li data-ripplecator class ="dark-ripples">
                        <a href="#" class="eliminar">
                            <span class="ca-icon-c"><i  class="zmdi zmdi-delete boton red f-35 boton red sa-warning" data-original-title="Eliminar" name="eliminar" data-toggle="tooltip" data-placement="bottom" title=""  ></i></span>
                            <div class="ca-content-c">
