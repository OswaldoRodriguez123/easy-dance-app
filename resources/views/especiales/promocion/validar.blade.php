                           ...
                           <div class="row p-t-20 p-b-0">
                               <div class="col-sm-4">
                                 <div class="form-group fg-line">
                                    <label for="etiqueta">Codigo</label>
                                    <input type="text" class="form-control input-sm" name="codigo" id="codigo" placeholder="Ej.">
                                 </div>
...
@section('js') 
        ...
        <script type="text/javascript">
            route_agregar="{{url('/')}}/especiales/promociones/validarcodigo";
