...
<section id="content">
        <div class="container">
           ...
           <div class="col-sm-6 text-left">
                <a class="btn-blanco m-r-10 f-16" href="{{url('/')}}/especiales/promociones"> <i class="zmdi zmdi-chevron-left zmdi-hc-fw"></i> Sección promoción</a>
            </div>

                <div class="col-sm-6 text-right">
                <a class="btn-blanco m-r-10 f-16" style="text-align: right" href="{{url('/')}}/especiales/promociones/detalle/{{$id}}"> Vista Previa <i class="zmdi zmdi-chevron-right zmdi-hc-fw"></i></a>
                </div>
            </div> 

            <br>
            
            <h4 class ="c-morado text-right">Promoción: {{$promocion->nombre}}</h4>
