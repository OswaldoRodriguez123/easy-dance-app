                    ...
                    <div class="modal-content">
                        ...
                        <form name="agregar_promocion" id="agregar_promocion" >
                           ...
                           <div class="row p-t-20 p-b-0">
                               ...
                               <div class="col-sm-6">
                                 <div class="form-group fg-line">
                                    <label for="apellido">Porcentaje Descuento</label>
                                    <input type="text" class="form-control input-sm" name="porcentaje_descuento" id="porcentaje_descuento" placeholder="">
                                 </div>
                               </div>
                               ...
                               <div class="col-sm-6">
                                    ...
                                    <label for="apellido">Fecha de Inicio</label>
                                            ...
                                            <input name="fecha_inicio" id="fecha_inicio" class="form-control date-picker" placeholder="seleciona..." type="text">
                                        </div>
                                    </div>
                                </div>
                               ...
                               <div class="col-sm-6">
                                    ...
                                    <label for="apellido">Fecha Final</label>
                                            <div class="dtp-container fg-line">
                                            <input name="fecha_final" id="fecha_final" class="form-control date-picker" placeholder="seleciona..." type="text">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                 <div class="form-group fg-line">
                                    ...
                                    <input type="text" class="form-control input-sm" name="edad" id="edad" placeholder="">
                                 </div>
                               </div>
                    ...
                    <div class="card">
                        ...
                        <div class="table-responsive">
                            ...
                            @foreach ($promocion as $promociones)
                                ...
                                <tr>
                                    <td>{{$promociones['id']}} <a href="{{url('/')}}/participante/alumno/editar/<?= $id ?>">Editar</a></td> 
