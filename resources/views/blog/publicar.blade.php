                ...
                <div class="container">
                    ...
                    <div class="card">
                        <div class="card-header text-center">
                            <span class="f-25 c-morado"><i class="icon_a-clases-grupales f-25" id="id-clase_grupal_id"></i> Agregar Entrada </span>                                                         
                        </div>
                        ...
                        <div class="card-body p-b-20">
                            ...
                            <div class="clearfix p-b-15"></div>
                              <div class="col-sm-12">
                                    ...
                                    <div class="input-group">
                                      ...
                                      <div class="fg-line">
                                      <input type="text" name="titulo" id="titulo" class="form-control input-sm proceso" placeholder="Ej. Entrada">
                                    </div>
                                    </div>
                               ...
                               <div class="col-sm-12">
                                  ...
                                  <label for="categoria">Categoria</label> <span class="c-morado f-700 f-16">*</span> <i class="p-l-5 tm-icon zmdi zmdi-help ayuda mousedefault" data-trigger="hover" data-toggle="popover" data-placement="right" data-content="Selecciona la categoria de la entrada" title="" data-original-title="Ayuda" data-html="true"></i>
                          ...
                          <div class="clearfix p-b-35"></div>
                              ...
                              <div class="col-sm-12">
                                <label for="apellido" id="id-imagen_footer">Imagen Footer</label></label><i class="p-l-5 tm-icon zmdi zmdi-help ayuda mousedefault" data-trigger="hover" data-toggle="popover" data-placement="right" data-content="Carga la imagen que ira al final de la entrada" title="" data-original-title="Ayuda"></i>
                                
                                <div class="clearfix p-b-15"></div>
                                  
                                <input type="hidden" name="imageFooter64" id="imageFooter64">
                                  <div class="fileinput fileinput-new" data-provides="fileinput">
                                    ...
                                    <div>
                                        <span class="btn btn-info btn-file">
                                            <span class="fileinput-new">Seleccionar Imagen</span>
                                            <span class="fileinput-exists">Cambiar</span>
                                            <input type="file" name="imagen_footer" id="imagen_footer" >
                                        </span>
                                        <a href="#" class="btn btn-danger fileinput-exists" data-dismiss="fileinput">Eliminar</a>
                                    </div>
                                </div>
                                  <div class="has-error" id="error-imagen_footer">
                                  <span >
                                      <small class="help-block error-span" id="error-imagen_footer_mensaje"  ></small>
                                  </span>
                                </div>
                              </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
      ...
      $("#imagen_footer").bind("change", function() {
          //alert('algo cambio');
          ...
          setTimeout(function(){
            ...
            var newimage = canvas.toDataURL("image/jpeg", 0.8);
            var image64 = $("input:hidden[name=imageFooter64]").val(newimage);
          },500);
