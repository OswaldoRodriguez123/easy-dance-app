                           ...
                           <div class="col-md-12">
                            ...
                            @foreach ($alumnos as $alumno)
                                ...
                                <tr id="row_{{$id}}" class="seleccion" >
                                    ...
                                    <i class="zmdi zmdi-refresh-alt f-20 p-r-10 pointer acciones" id="{{$id}}" name="operacion" data-trigger="hover" data-toggle="popover" data-placement="left" data-content="" title="" data-original-title="Restablecer"></i></td>
                                </tr>
                            @endforeach 
