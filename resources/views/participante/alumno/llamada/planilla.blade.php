...
@section('content')
          ...
          <div class="modal fade" id="modalAsunto-Llamada" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <form name="edit_asunto_llamada" id="edit_asunto_llamada"  >
                        ...
                        <div class="modal-footer p-b-20 m-b-20">
                            ...
                            <div class="col-sm-12">                            
                              ...
                              <a class="btn-blanco m-r-5 f-12 guardar" id="guardar" href="#" data-formulario="edit_asunto_llamada" data-update="asunto" >  Guardar <i class="zmdi zmdi-chevron-right zmdi-hc-fw"></i></a>
                ...
                <div class="container">
                    ...
                    <div class="block-header">
                      @if($usuario_tipo == 1 OR $usuario_tipo == 5 || $usuario_tipo == 6)
                       <a class="btn-blanco m-r-10 f-16" href="{{url('/')}}/participante/alumno/llamadas/{{$llamada->usuario_id}}" onclick="procesando()"> <i class="zmdi zmdi-chevron-left zmdi-hc-fw"></i> Sección Llamadas</a>
                        ...
                        <div class="container">
                         ...
                         <div class="col-sm-12">
                          ...
                          <div class="col-sm-12">
                           ...
                           @if($usuario_tipo == 1 OR $usuario_tipo == 5 || $usuario_tipo == 6)
                              <tr class="detalle" data-toggle="modal" href="#modalAsunto-Llamada">
                            ...
                            @endif
                             <td>
                               <span  class="m-l-10 m-r-5 f-16" ><i id="estatus-asunto_llamada_id" class="zmdi {{ empty($llamada->asunto_llamada_id) ? 'c-amarillo zmdi-dot-circle' : 'c-verde zmdi-check' }} zmdi-hc-fw"></i></span>
                               <span class="m-l-10 m-r-10"> <i class="icon_a icon_a-campana f-22"></i> </span>
                               <span class="f-14"> Asunto de la llamada </span>
                             </td>
                             <td class="f-14 m-l-15" ><span id="llamada-asunto_llamada_id" class="capitalize" data-valor="{{$llamada->asunto_llamada_id}}" >{{$llamada->asunto}}</span> <span class="pull-right c-blanco"><i class="zmdi zmdi-edit f-22"></i></span> </td>
                            </tr>
                            @if($usuario_tipo == 1 OR $usuario_tipo == 5 || $usuario_tipo == 6)
...
@section('js') 
   <script type="text/javascript">
    route_update="{{url('/')}}/participante/alumno/llamadas/update";
    route_eliminar="{{url('/')}}/participante/alumno/llamadas/eliminar/";
    route_principal="{{url('/')}}/participante/alumno/llamadas/{{$llamada->usuario_id}}";
        ...
        $.each(form, function (n, c) {
          if(c.name=='asunto_llamada_id'){
            ...
            if(c.value=='1'){ 
              ...
              var valor='Ofrecimiento de un servicio </span>';
            }else{
              var valor='Ofrecimiento de un servicio </span>';
            }
