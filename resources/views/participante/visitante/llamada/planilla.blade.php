                ...
                <div class="container">
                    ...
                    <div class="block-header">
                      @if($usuario_tipo == 1 OR $usuario_tipo == 5 || $usuario_tipo == 6)
                       <a class="btn-blanco m-r-10 f-16" href="{{url('/')}}/participante/visitante/llamadas/{{$id}}" onclick="procesando()"> <i class="zmdi zmdi-chevron-left zmdi-hc-fw"></i> Sección Llamadas</a>
...
@section('js') 
   <script type="text/javascript">
    ...
    function limpiarMensaje(){
        var campo = ["fecha_siguiente", "hora_siguiente", "estatus"];
        fLen = campo.length;
        for (i = 0; i < fLen; i++) {
