            ...
            <div class="modal fade" style="z-index: 3000" id="modalRepresentante" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form name="agregar_visitante" method="POST" action="visitante/agregar" >
                           ...
                           <div class="row p-t-20 p-b-0">
                               ...
                               <div class="col-sm-6">
                                 <div class="form-group fg-line">
                                    ...
                                    <input type="text" class="form-control input-sm" name="como_se_entero" id="como_se_entero" placeholder="">
                                 </div>
                               </div>
                    ...
                    <div class="card">
                        ...
                        <div class="table-responsive">
                            ...
                            @foreach ($visitante as $visitantes)
                                ...
                                <tr>
                                    <td>{{$visitantes['identificacion']}}</td>
                                    <td>{{$visitantes['sexo']}}</td>
                                    <td>{{$visitantes['nombre']}} {{$visitantes['apellido']}} </td>
