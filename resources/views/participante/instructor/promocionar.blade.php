                  ...
                  <div class="clearfix p-b-15"></div>
                    ...
                    <ul class="rrssb-buttons clearfix">
                      ...
                      <li class="rrssb-facebook">
                        ...
                        <a href="https://www.facebook.com/sharer/sharer.php?u={{url('/')}}/instructores/detalle/{{$id}}" class="popup">
                      ...
                      <li class="rrssb-twitter">
                        ...
                        <a href="https://twitter.com/intent/tweet?text=Reserva clases personalizadas con {{$instructores_academia->nombre}} {{url('/')}}/instructores/detalle/{{$id}}"
                        class="popup">
