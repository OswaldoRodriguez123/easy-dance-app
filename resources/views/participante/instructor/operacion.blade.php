...
<section id="content">
        <div class="container">
            ...
            <div class="col-sm-6 text-left">
                ...
                <a class="btn-blanco m-r-10 f-16" style="text-align: right" href="{{url('/')}}/participante/instructor/detalle/{{$id}}"> Vista Previa <i class="zmdi zmdi-chevron-right zmdi-hc-fw"></i></a>
                </div>
            ...
            <ul class="ca-menu-c col-sm-5" style="width: 720px;">
                    ...
                    <li data-ripplecator class ="dark-ripples">
                        <a href="#" class="eliminar">
                            <span class="ca-icon-c"><i  class="zmdi zmdi-delete boton red f-35 boton red sa-warning" data-original-title="Eliminar" id="{{$id}}" name="eliminar" data-toggle="tooltip" data-placement="bottom" title=""  ></i></span>
                            <div class="ca-content-c">
