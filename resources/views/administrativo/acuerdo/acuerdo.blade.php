                      ...
                      <div class="card">
                        ...
                        <div class="col-xs-12 text-left">
                          <ul class="tab-nav tn-justified" role="tablist">
                            ...
                            <li class="waves-effect active"><a href="{{url('/')}}/administrativo/acuerdos/generar" aria-controls="home11"><div class="icon_a icon_a-acuerdo-de-pago f-30"></div><p style=" margin-bottom: -2px;">Acuerdos</p></a></li>
