                           ...
                           <div class="col-md-12">
                            ...
                            <!-- @foreach ($facturas as $factura)
                                ...
                                <tr id="row_{{$id}}" class="seleccion" >
                                    ...
                                    <td class="text-center previa">{{$factura->nombre}} {{$factura->apellido}}</td>
                                    <td class="text-center previa">{{$factura->fecha}}</td>
                                    <td class="text-center previa">1500</td>
                                    <td class="text-center"> <i data-toggle="modal" name="correo" id={{$id}} class="zmdi zmdi-email f-20 p-r-10"></i> <i data-toggle="modal" name="pagar" id={{$id}} class="icon_a-pagar f-20 p-r-10"></i> <i data-toggle="modal" name="eliminar" id={{$id}} class="zmdi zmdi-delete f-20 p-r-10"></i></td>
                                </tr>
