                      ...
                      <div class="card">
                        <div class="card-header">
                          ...
                          <ul class="tab-nav tn-justified" role="tablist">
                                    ...
                                    <li class="waves-effect"><a href="{{url('/')}}/reportes" aria-controls="home11" onclick="procesando()"><div class="icon_d icon_d-reporte f-30"></div><p style=" margin-bottom: -2px;">Reportes</p></a></li>
...
<script type="text/javascript">
  ...
  route_factura="{{url('/')}}/administrativo/pagos/proforma";
      ...
      var route = route_agregar;
                ...
                $.ajax({
                    url: route,
                        ...
                        type: 'POST',
                        dataType: 'json',
                        data:datos + "&impuestoglobal="+impuestoglobal ,
                    success:function(respuesta){
                      setTimeout(function(){ 
                        var nFrom = $(this).attr('data-from');
                        var nAlign = $(this).attr('data-align');
                        ...
                        if(respuesta.status=="OK"){
                          ...
                          subtotalfinal = parseFloat(precioint)
