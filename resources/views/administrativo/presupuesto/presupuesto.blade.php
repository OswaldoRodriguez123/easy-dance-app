                      ...
                      <div class="card">
                        <div class="card-header">
                          ...
                          <ul class="tab-nav tn-justified" role="tablist">
                                    ...
                                    <li class="waves-effect"><a href="{{url('/')}}/reportes/administrativo"><div class="icon_d icon_d-reporte f-30" onclick="procesando()"></div><p style=" margin-bottom: -2px;">Reportes</p></a></li>
