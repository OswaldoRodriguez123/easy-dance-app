                      ...
                      <div class="card">
                        ...
                        <div class="col-xs-12 text-left">
                          <ul class="tab-nav tn-justified" role="tablist">
                              <li class="waves-effect"><a href="{{url('/')}}/administrativo/pagos/generar" aria-controls="home11"><div class="icon_a icon_a-pagar f-30"></div><p style=" margin-bottom: -2px;">Pagos</p></a></li>
                              ...
                              <li class="waves-effect active"><a href="{{url('/')}}/administrativo/presupuestos/generar" aria-controls="home11"><div class="icon_a icon_a-presupuesto f-30"></div><p style=" margin-bottom: -2px;">Presupuestos</p></a></li>
