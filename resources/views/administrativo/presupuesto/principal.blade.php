            ...
            <section id="content">
                <div class="container">
                    ...
                    <div class="block-header">
                        <a class="btn-blanco m-r-10 f-16" href="/administrativo/presupuestos/generar" onclick="procesando()"> <i class="zmdi zmdi-chevron-left zmdi-hc-fw"></i> Sección Presupuestos</a>
                    ...
                    <div class="card">
                        ...
                        <br><br><p class="text-center opaco-0-8 f-22"><i class="icon_a-presupuesto p-r-5"></i> Área de Presupuesto</p>
...
@section('js') 
        ...
        <script type="text/javascript">
            route_detalle="{{url('/')}}/administrativo/presupuestos/detalle";
            route_eliminar="{{url('/')}}/administrativo/presupuestos/eliminar/";
