                ...
                <div class="container">
                    ...
                    <div class="card">
                        <div class="card-header text-center">
                            ...
                            <span class="f-30 c-morado">Hora de Continuar </span>                                                         
                        </div>
                           ...
                           <input type="hidden" name="_token" value="{{ csrf_token() }}">
                            ...
                            <div class="clearfix p-b-15"></div>
                              ...
                              <div class="text-center">
                               <span class="f-25 c-morado text-center">¡Gracias por usar Easy Dance!</span>
                                </div>

                               <div class="clearfix p-b-15"></div>

                                <p class = "f-18">Lamentablemente, el período de tu prueba ha terminado, pero estamos muy deseosos de continuar trabajando contigo. Para mantener el acceso, sólo tiene que introducir la información de pago y confirma tu plan de preferencia.</p>

                                <p class = "f-18">Vamos a contribuir con tu crecimiento, pero si sientes que  no lo hacemos, puedes darle de baja a aplicación en el momento que desees.</p> 
                            ...
                            <div class="col-sm-6 text-center">    
                              ...
                              <a class="btn-blanco m-r-10 f-22 guardar" href="#" id="guardar"> Empieza mi Subscripción
