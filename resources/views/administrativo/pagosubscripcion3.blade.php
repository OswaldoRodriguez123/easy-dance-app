                          ...
                          <form name="agregar_regalo" id="agregar_regalo"  >
                           <input type="hidden" name="_token" value="{{ csrf_token() }}">
                            ...
                            <div class="clearfix p-b-15"></div>
                              ...
                              <div class="clearfix p-b-15"></div>
                                ...
                                <div class="col-sm-6">
                                  ...
                                  <p class = "f-22">Para continuar recibiendo  de nuestros servicios, debes  elegir un  plan y método de pago en la siguiente pantalla. Es rápido y fácil</p>
                            ...
                            <div class="col-sm-6 text-center">    
                              ...
                              <a class="btn-blanco m-r-10 f-22 guardar" href="#" id="guardar"> Pagar con tarjeta de crédito
