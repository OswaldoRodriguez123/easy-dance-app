                           ...
                           <div class="col-md-12">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center" data-column-id="acciones" data-order="desc">Acciones</th>
                                </tr>
                            </thead>
                            ...
                            @foreach ($actividades as $actividad)
                                <?php 
                                  ...
                                  $tipo = $actividad['tipo']; 
                                ?>
                                <tr id="{{$tipo}}-{{$id}}" data-imagen="{{$actividad['imagen']}}" data-id="{{$id}}" data-tipo="{{$tipo}}" class="seleccion"> 
                                    ...
                                    <td>
                                      <a class="reservar">
                                        <i class="icon_a-reservaciones f-16"></i>
                                      </a>
                                    </td>
                                </tr>
                            @endforeach  
