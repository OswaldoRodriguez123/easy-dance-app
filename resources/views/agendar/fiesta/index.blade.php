            ...
            <div class="modal fade" style="z-index: 3000" id="modalRepresentante" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form name="agregar_fiesta" method="POST" action="fiesta/agregar" >
                              ...
                              <div class="col-sm-6">
                               ...
                               <div class="col-sm-6">
                                 <div class="form-group fg-line">
                                    ...
                                    <input type="text" class="form-control input-sm" name="link_video" id="link_video" placeholder="">
                                 </div>
                               </div>
                    ...
                    <div class="card">
                        ...
                        <div class="table-responsive">
                            ...
                            @foreach ($fiesta as $fiestas)
                                <?php $id = $fiestas['id']; ?>
                                <tr>
                                    <td>{{$fiestas['nombre']}}</td>
                                    <td>{{$fiestas['fecha']}}</td>
                                    <td>{{$fiestas['hora_inicio']}} {{$fiestas['hora_final']}} </td>
