...
<div class="imagen_principal_progreso" style="background-repeat: no-repeat; background-size: cover;background-position: center; background: url('{{url('/')}}/assets/uploads/fiesta/{{$fiesta->imagen}}');"></div>
