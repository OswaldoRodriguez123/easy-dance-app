...
<div class="imagen_principal_progreso" style="background: url('{{url('/')}}/assets/uploads/fiesta/{{$fiesta->imagen}}'); background-repeat: no-repeat; background-size: cover; background-position: center;"></div>
...
@section('js') 
  ...
  function errores(merror){
    ...
    $("#add").click(function(){
       ...
       $('#tableañadir tbody').on( 'click', 'i.zmdi-delete boton red', function () {
