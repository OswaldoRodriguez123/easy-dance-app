...
@section('js') 
        ...
        route_update="{{url('/')}}/agendar/fiestas/patrocinadores/update/patrocinador";
        route_eliminar="{{url('/')}}/agendar/fiestas/patrocinadores/eliminar/";
        route_enviar="{{url('/')}}/agendar/fiestas/patrocinadores/enviar/";
