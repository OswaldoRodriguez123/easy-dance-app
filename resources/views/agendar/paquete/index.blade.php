            ...
            <div class="modal fade" style="z-index: 3000" id="modalRepresentante" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form name="agregar_paquete" method="POST" action="fiesta/agregar" >
            ...
            <div class="modal fade" id="modalAgregar" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <form name="agregar_paquete" id="agregar_paquete" >
                           <input type="hidden" name="_token" value="{{ csrf_token() }}">
                           <div class="modal-body">                           
                           <div class="row p-t-20 p-b-0">
                               <div class="col-sm-6">
                              ...
                              <div class="col-sm-6">
                                 <div class="form-group fg-line">
                                    <label for="nombre">Cantidad Clases Grupales</label>
                                    <input type="text" class="form-control input-sm" name="cantidad_clases_grupales" id="cantidad_clases_grupales" placeholder="">
                                 </div>
                               </div>

                                <div class="col-sm-6">
                                 <div class="form-group fg-line">
                                    <label for="nombre">Cantidad Clases Personalizadas</label>
                                    <input type="text" class="form-control input-sm" name="cantidad_clases_personalizadas" id="cantidad_clases_personalizadas" placeholder="">
                                 </div>
                               </div>

                                <div class="col-sm-6">
                                 <div class="form-group fg-line">
                                    <label for="nombre">Cantidad Fiestas</label>
                                    <input type="text" class="form-control input-sm" name="cantidad_fiestas" id="cantidad_fiestas" placeholder="">
                                 </div>
                               </div>

                                <div class="col-sm-6">
                                 <div class="form-group fg-line">
                                    <label for="nombre">Cantidad Talleres</label>
                                    <input type="text" class="form-control input-sm" name="cantidad_talleres" id="cantidad_talleres" placeholder="">
                                 </div>
                               </div>
...
@section('js') 
		...
		<script type="text/javascript">
            route_principal="{{url('/')}}/especiales/paquetes";
            route_agregar="{{url('/')}}/especiales/paquetes/agregar";
            route_eliminar="{{url('/')}}/especiales/paquetes/eliminar/";
         ...
         var token = $('input:hidden[name=_token]').val();
            ...
            $("#guardar").click(function(){
                ...
                var token = $('input:hidden[name=_token]').val();
                var datos = $( "#agregar_paquete" ).serialize(); 
