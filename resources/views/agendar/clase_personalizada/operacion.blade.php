                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <form name="cancelar_clase" id="cancelar_clase"  >
                                       ...
                                       <input type="hidden" name="id" value="{{$clase_personalizada->id}}"></input>  
                                       ...
                                       <div class="row p-t-20 p-b-0">
                                           ...
                                           <div class="col-sm-3">
                                                ...
                                                <span class="p-l-10 f-16 f-700"> {{$clase_personalizada->instructor_nombre}} {{$clase_personalizada->instructor_apellido}} </span>
                                           ...
                                           <div class="col-sm-9">
                                            ...
                                            <p class="f-16"> <span class="f-700">Hora:</span> {{$clase_personalizada->hora_inicio}} - {{$clase_personalizada->hora_final}}</p>

                                            <p class="f-16"> <span class="f-700">Fecha:</span> {{$clase_personalizada->fecha_inicio}} </p> 

                                            <p class="f-16"> <span class="f-700">Especialidad:</span> {{$clase_personalizada->especialidad_nombre}} </p>
                                    ...
                                    <div class="modal-footer p-b-20 m-b-20">
                                        ...
                                        <div class="col-sm-6">                          
                                          <button type="button" class="btn-blanco btn m-r-10 f-16 guardar" id="guardar" name="guardar" > Completar la cancelación</button>
           ...
           <div class="block-header">
            ...
            <ul class="ca-menu-c col-sm-5" style="width: 720px;">
                ...
                <li data-ripplecator class ="dark-ripples">
                        <a data-toggle="modal" href="#modalCancelar" class="cancelar">
                            <span class="ca-icon-c"><i  class="zmdi zmdi-close-circle-o zmdi-hc-fw f-40 boton red sa-warning" name="cancelar" id="{{$id}}" data-original-title="Cancelar" data-toggle="tooltip" data-placement="bottom" title=""  ></i></span>
