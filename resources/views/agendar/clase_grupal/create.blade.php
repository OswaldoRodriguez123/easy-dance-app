                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-b-20">
                          <form name="agregar_clase_grupal" id="agregar_clase_grupal"  >
                           <input type="hidden" name="_token" value="{{ csrf_token() }}">
                            ...
                            <div class="clearfix p-b-15"></div>
                              <div class="col-sm-12">
                                    ...
                                    <label for="nombre" id="id-clase_grupal_id">Nombre</label> <span class="c-morado f-700 f-16">*</span> <i class="p-l-5 tm-icon zmdi zmdi-help ayuda mousedefault" data-trigger="hover" data-toggle="popover" data-placement="right" data-content="Selecciona el nombre de la clase grupal, en caso de no haberla registrado, debes dirigirte al área de configuración general en la sección de clases grupales y procede a crear el registro" title="" data-original-title="Ayuda"></i>
                           ...
                           <div class="col-sm-12">
                            <label for="apellido" id="id-imagen">Cargar Imagen</label><i class="p-l-5 tm-icon zmdi zmdi-help ayuda mousedefault" data-trigger="hover" data-toggle="popover" data-placement="right" data-content="Ingresa las normativas de tu academia, de modo que, tus alumnos puedan descargar y conocer desde su panel de control las normas que rigen tu institución, este soporta sólo el tipo de documento en formato PDF" title="" data-original-title="Ayuda"></i>
