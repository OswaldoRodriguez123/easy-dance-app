            ...
            <div class="modal fade" style="z-index: 3000" id="modalRepresentante" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form name="agregar_clasegrupal" method="POST" action="cursos/agregar" >
            ...
            <div class="modal fade" id="modalAgregar" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <form name="agregar_clasegrupal" id="agregar_clasegrupal" >
                           <input type="hidden" name="_token" value="{{ csrf_token() }}">
                           <div class="modal-body">                           
                           <div class="row p-t-20 p-b-0">
                                <div class="card-body card-padding">
                                      <div class="col-sm-6">
                                          <p class="c-black f-500 m-b-20">Nombre</p>
                    ...
                    <div class="modal-content">
                        ...
                        <form name="agregar_inscripcion" id="agregar_inscripcion" >
                           ...
                           <div class="row p-t-20 p-b-0">
                                          ...
                                          <div class="form-group">
                                              <div class="fg-line">
                                                  <div class="select">
                                                      ...
                                                      <option value = "{{$alumnos['id']}}">{{$alumnos['nombre']}} {{$alumnos['apellido']}} {{$alumnos['identificacion']}}</option>
                                                      @endforeach 
                                                      </select>
                                              </div>
                                          </div>
                               ...
                               <div class="col-sm-6">
                                 <div class="form-group fg-line">
                                    <label for="nombre">Costo Inscripcion</label>
                                    <input type="text" class="form-control input-sm" name="costo_inscripcion" id="costo_inscripcion" placeholder="" value="">
                                 </div>
                               </div>

                               <div class="col-sm-6">
                                 <div class="form-group fg-line">
                                    <label for="apellido">Costo Mensualidad</label>
                                    <input type="text" class="form-control input-sm" name="costo_mensualidad" id="costo_mensualidad" placeholder="">
                                 </div>
                               </div>

                                  <div class="col-sm-6">
                                    <div class="form-group fg-line">
                                    <label for="apellido">Fecha de Pago</label>
                                            <div class="dtp-container fg-line">
                                            <input name="fecha_pago" id="fecha_pago" class="form-control date-picker" placeholder="Seleccione..." type="text">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="modal-footer">
                            <button type="button" id="inscripcion" class="btn btn-primary">Guardar</button>
                            <button type="button" class="btn btn-default" data-dismiss="modal">Cancelar</button>
                        </div></form>
                    </div>
                </div>
                        ...
                        <div class="table-responsive">
                            ...
                            @foreach ($clase_grupal_join as $clase_grupal)
                              <?php $id = $clase_grupal->id ?>
                                <tr>
                                    <td>{{$clase_grupal->clase_grupal_nombre}}</td>
                                    <td>{{$clase_grupal->especialidad_nombre}}</td>
                                    <td>{{$clase_grupal->hora_inicio}} {{$clase_grupal->hora_final}}</td>
                                    ...
                                    <td class="text-center"> <i data-toggle="modal" href="#modalInscripcion" class="zmdi zmdi-filter-list f-20 p-r-10"></i> <i id = "<?= $id ?>" class="zmdi zmdi-delete f-20 sa-warning"></i></td>
<!--                                       <td class="text-center"> <i data-toggle="modal" href="#modalInscripcion" class="zmdi zmdi-filter-list f-20 p-r-10"></i> <i id = "<?= $id ?>" class="zmdi zmdi-delete f-20 sa-warning"></i></td> -->
                                </tr>
                            @endforeach  
                                <tr>
...
@section('js') 
		...
		<script type="text/javascript">
			...
			$('.sa-warning').click(function(){
                id = this.id;
                swal({   
                    title: "Desea eliminar el curso grupal?",   
         ...
         var token = $('input:hidden[name=_token]').val();
            ...
            $("#guardar").click(function(){
                ...
                console.log('guardar');
                /*limpiarMensaje();*/
                var route = "{{url('/')}}/agendar/cursos/inscripcion/";
                var token = $('input:hidden[name=_token]').val();
                var datos = $( "#agregar_inscripcion" ).serialize() + '&NonFormValue=' + $this.id; 
