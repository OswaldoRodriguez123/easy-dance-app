            ...
            <section id="content">
                <div class="container">
                    ...
                    <div class="block-header">
                        <a class="btn-blanco m-r-10 f-16" href="{{url('/')}}/agendar/clases-grupales" onclick="procesando()"> <i class="zmdi zmdi-chevron-left zmdi-hc-fw"></i> Volver</a>
                    ...
                    <div class="card">
                        <div class="card-header text-right">
                            ...
                            <br><br><p class="text-center opaco-0-8 f-22"><i class="zmdi zmdi-mood-bad zmdi-hc-fw f-25"></i> Riesgo de Ausencia</p>
                        ...
                        <div class="table-responsive row">
                           <div class="col-md-12">
                            ...
                            <thead>
                                <tr>
                                    <th class="text-center" data-column-id="identificacion" data-order="desc">Identificación</th>
                                    ...
                                    <th class="text-center" data-column-id="inasistencias"></th>                        
                                </tr>
                            </thead>
                            <tbody>
