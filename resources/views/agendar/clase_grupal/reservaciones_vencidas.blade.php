            ...
            <section id="content">
                <div class="container">
                    ...
                    <div class="block-header">
                        <a class="btn-blanco m-r-10 f-16" href="{{url('/')}}/agendar/clases-grupales/participantes/{{$id}}" onclick="procesando()"> <i class="zmdi zmdi-chevron-left zmdi-hc-fw"></i> Volver</a>
                    ...
                    <div class="card">
                        <div class="card-header text-right">
                            ...
                            <br><br><p class="text-center opaco-0-8 f-22"><i class="zmdi zmdi-mood-bad zmdi-hc-fw f-25"></i> Reservaciones Vencidas</p>
