            ...
            <div class="modal fade" style="z-index: 3000" id="modalRepresentante" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form name="agregar_show" method="POST" action="fiesta/agregar" >
            ...
            <div class="modal fade" id="modalAgregar" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <form name="agregar_show" id="agregar_show" >
                           <input type="hidden" name="_token" value="{{ csrf_token() }}">
                           <div class="modal-body">                           
                           <div class="row p-t-20 p-b-0">
                               <div class="col-sm-6">
                               ...
                               <div class="col-sm-6">
                                    ...
                                    <label for="apellido">Fecha</label>
                                            <div class="dtp-container fg-line">
                                            <input name="fecha" id="fecha" class="form-control date-picker" placeholder="seleciona..." type="text">
                                        </div>
                                    </div>
                                </div>
                              ...
                              <div class="col-sm-6">
                                 <div class="form-group fg-line">
                                    ...
                                    <input type="text" class="form-control input-sm" name="lugar" id="lugar" placeholder="">
                                 </div>
                               </div>
                        ...
                        <div class="table-responsive">
                            ...
                            @foreach ($show as $shows)
                                ...
                                <tr>
                                    <td>{{$shows['nombre']}}</td>
                                    <td>{{$shows['fecha']}}</td>
                                    <td>{{$shows['hora_inicio']}} {{$shows['hora_final']}} </td>
...
@section('js') 
		...
		<script type="text/javascript">
            route_principal="{{url('/')}}/agendar/shows";
            route_agregar="{{url('/')}}/agendar/shows/agregar";
            route_eliminar="{{url('/')}}/agendar/shows/eliminar/";
         ...
         var token = $('input:hidden[name=_token]').val();
            ...
            $("#guardar").click(function(){
                ...
                var token = $('input:hidden[name=_token]').val();
                var datos = $( "#agregar_show" ).serialize(); 
