                ...
                <div class="container">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <br><br><p class="text-center opaco-0-8 f-22" id="id-horario"><i class="icon_a-talleres p-r-5"></i> Taller: {{$taller->nombre}}</p>
                            <p class="text-center"><span class="m-l-10 m-r-10"> <i class="zmdi zmdi-calendar-check f-22"></i> </span> <span class="f-14">Fecha Desde / Hasta: </span> {{\Carbon\Carbon::createFromFormat('Y-m-d',$taller->fecha_inicio)->format('d/m/Y')}} - {{\Carbon\Carbon::createFromFormat('Y-m-d',$taller->fecha_final)->format('d/m/Y')}}</p>
                            <hr class="linea-morada">

                            </div>                                                        
                        </div>
                        <form name="agregar_horario" id="agregar_horario">
                        ...
                        <div class="card-body p-b-20">
	                        ...
	                        <div class="clearfix p-b-35"></div>
                              ...
                              <div class="col-sm-2 text-center">
                                <div class="fg-line">
                                  <input type="text" class="form-control date-picker input-sm pointer" name="fecha" id="fecha" placeholder="Ej. 00/00/0000">    
                                </div>
                              </div>
...
@section('js') 
    ...
    <script type="text/javascript">      
      ...
      $.ajaxSetup(
      {
    	...
    	route_horario="{{url('/')}}/agendar/talleres/multihorario/agregarhorario";
      route_eliminar="{{url('/')}}/agendar/talleres/multihorario/eliminarhorario";
      route_cancelar = "{{url('/')}}/agendar/talleres/multihorario/cancelarhorarios";
      route_guardar = "{{url('/')}}/agendar/talleres/multihorario/guardarhorarios";
		...
		$("#add").click(function(){
                ...
                var datos = $( "#agregar_horario" ).serialize(); 
                limpiarMensaje();
                    ...
                    success:function(respuesta){
                      setTimeout(function(){ 
                        ...
                        if(respuesta.status=="OK"){
                          ...
                          var fecha = respuesta.array.fecha;
  ...
  $('#tablelistar tbody').on( 'click', 'i.zmdi-delete', function () {
      ...
      var campo = ["instructor_acordeon_id", "especialidad_acordeon_id", "estudio_id", "hora_final_acordeon", "hora_inicio_acordeon", "fecha"];
        fLen = campo.length;
        for (i = 0; i < fLen; i++) {
  ...
  $( "#cancelar" ).click(function() {
    ...
    $.ajax({
        ...
        $('html,body').animate({
        scrollTop: $("#id-horario").offset().top-90,
        }, 1000);
      });
