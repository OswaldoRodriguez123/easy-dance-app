    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form name="form_agregar" id="form_agregar"  >
                ...
                <input type="hidden" id="taller_id" name="taller_id" value="{{$taller->id}}">
            ...
            <section id="content">
                <div class="container">
                    ...
                    <div class="block-header">
                        <a class="btn-blanco m-r-10 f-16" href="{{url('/')}}/agendar/talleres/detalle/{{$taller->id}}" onclick="procesando()"> <i class="zmdi zmdi-chevron-left zmdi-hc-fw"></i> Volver</a>
...
<script type="text/javascript">
    ...
    route_agregar="{{url('/')}}/agendar/talleres/agregar-egreso";
    route_eliminar="{{url('/')}}/agendar/talleres/eliminar-egreso/";
