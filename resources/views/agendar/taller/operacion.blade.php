...
<section id="content">
        <div class="container">
           <div class="block-header">
                ...
                <a class="btn-blanco m-r-10 f-16" href="{{url('/')}}/agendar/talleres"> <i class="zmdi zmdi-chevron-left zmdi-hc-fw"></i> Sección Taller</a>
                </div>
                <div class="col-sm-6 text-right">
                <a class="btn-blanco m-r-10 f-16" style="text-align: right" href="{{url('/')}}/agendar/talleres/detalle/{{$id}}"> Vista Previa <i class="zmdi zmdi-chevron-right zmdi-hc-fw"></i></a>
                </div>
            </div> 

            <br>
            
            <h4 class ="c-morado text-right">Taller: {{$taller->nombre}}</h4>
...
@section('js') 
  ...
  $(".participantes").click(function(){
    ...
    window.location = "{{url('/')}}/agendar/talleres/participantes/{{$id}}";
   ...
   $(".egresos").click(function(){
        ...
        window.location = "{{url('/')}}/agendar/talleres/egresos/{{$id}}";
