<header id="header" class="clearfix" data-current-skin="orange">
            <ul class="header-inner">
                ...
                <li class="logo hidden-xs" popover-placement="bottom" popover-trigger="mouseenter" popover="Inicio">
                    <a data-ui-sref="home" href="/inicio"data-ng-click="edctrl.sidebarStat($event)"><!--Easy Dance--> <img src="{{url('/')}}/assets/img/logo.png" class="img-opaco" width="90"></a>
                </li>
                ...
                <li class="pull-right m-r-5">
                    <ul class="top-menu">
                        <li id="toggle-width" class="hidden" data-original-title="" type="button" data-toggle="popover" data-placement="bottom" title="" data-trigger='hover' data-content="Suiche" >
                        ...
                        <li class="dropdown" data-original-title="" data-content="Calendario" data-toggle="popover" data-placement="bottom" title="" type="button" data-trigger="hover">
                            <a href="{{url('/')}}/agendar">
                                <i class="tm-icon zmdi-check f-18 f-18"></i>
                            </a>
                        </li>
                        ...
                        <li class="dropdown" data-original-title="" data-content="Calendario" data-toggle="popover" data-placement="bottom" title="" type="button" data-trigger="hover">
                            <a href="{{url('/')}}/configuracion">
                                <i class="tm-icon zmdi zmdi-settings f-18 f-18"></i>
                            </a>
                        </li>  

                        <li id="chat-trigger" data-trigger="#chat" data-content="Asistencia" data-toggle="popover" data-original-title="Asistencia" type="button" data-toggle="tooltip" data-placement="bottom" title="" >
