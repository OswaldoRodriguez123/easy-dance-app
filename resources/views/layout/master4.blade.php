      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse" style="border-color: none">
          <ul class="nav navbar-nav" style="margin-top: 5px">
            ...
            <li data-toggle="collapse" data-target=".nav-collapse" style="margin-top:5px"><a id = "tab_empresa" href="#empresa" aria-controls="empresa" role="tab" data-toggle="tab"> <span style="color:#4E1E43; font-size:20px"> Empresa</span></a></li>
            <li data-toggle="collapse" data-target=".nav-collapse" style="margin-top:5px"><a id = "tab_nosotros" href="#nuestro-equipo" aria-controls="invitar" role="tab" data-toggle="tab"> <span style="color:#4E1E43; font-size:20px">Nuestro Equipo</span></a></li>
            <li data-toggle="collapse" data-target=".nav-collapse" style="margin-top:5px"><a id = "tab_faqs" href="#faqs" aria-controls="nuestro-equipo" role="tab" data-toggle="tab"> <span style="color:#4E1E43; font-size:20px"> FAQS</span></a></li>
