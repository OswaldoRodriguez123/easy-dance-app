      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse" style="border-color: none">
          <ul class="nav navbar-nav" style="margin-top: 5px">
            ...
            @if(Auth::check())
              <li data-toggle="collapse" data-target=".nav-collapse" style="margin-top:5px"><a href="{{url('/')}}/inicio"><span style="color:#4E1E43; font-size:20px"> Inicio</span></a></li>
            @endif
            ...
            <li data-toggle="collapse" data-target=".nav-collapse" style="margin-top:5px"><a id = "tab_grupo" href="#rango_grupos" aria-controls="rango_grupos" role="tab" data-toggle="tab"> <span style="color:#4E1E43; font-size:20px"> Rango de los grupos</span></a></li>
            @if($activa)
