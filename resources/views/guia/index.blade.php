...
@section('content')
  <!-- ENHORABUENA -->
    ...
    <div class="container">
      ...
      <a class="btn-blanco m-r-10 f-16" href="{{url('/')}}/participante/alumno" onclick="procesando()"> <i class="zmdi zmdi-chevron-left zmdi-hc-fw"></i> Sección Alumnos</a>
      ...
      <div class="card">
        <div class="card-header">
            ...
            <div class="f-30 text-center">
              Ahora cuéntanos ¿qué deseas hacer?
            </div>
        </div>
        <div class="card-body">
            <div class="clearfix"></div>
            ...
            <div class="text-center guia">
              <hr>
              <div class="clearfix"></div><br>
              <p class="m-t-5 m-b-5 f-22"><a href="{{ url('agendar/clases-grupales') }}" >Agregar al  participante a una clase grupal <i class="zmdi zmdi-arrow-right zmdi-hc-fw"></i>  
              ...
              <div class="clearfix"></div><br>
              <p class="m-t-5 m-b-5 f-22"><a href="{{ url('agendar/talleres') }}" >Agregar al  participante  a un Taller <i class="zmdi zmdi-arrow-right zmdi-hc-fw"></i>   <i class="icon_a-talleres f-50 padding-talleres"></i> </a></p>
              <div class="clearfix"></div><br>
              <hr>
