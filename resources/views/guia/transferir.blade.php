    ...
    <div class="container">
        ...
        <div class="card-body">
            ...
            <div class="text-center guia">
              ...
              <div class="clearfix"></div><br>
              <p class="m-t-5 m-b-5 f-22"><a  href="{{ url('especiales/promociones') }}">Transferir al  participante a una Promoción <i class="zmdi zmdi-arrow-right zmdi-hc-fw"></i> <i class="icon_a-promocion f-50 padding-promocion"></i> </a></p> 
