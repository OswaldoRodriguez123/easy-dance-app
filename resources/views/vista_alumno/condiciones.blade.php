                        ...
                        <div class="col-sm-8" style ="background-color:#f5f5f5; color:#333333; padding:8.5px; margin: 0 0 9px; border-radius: 2px; border:1px solid #cccccc; overflow-y: auto; height:400px">
                                  ...
                                  <p style="font-size: 12px" name="pre_condiciones" id="pre_condiciones">
                                    ...
                                    <div class="col-md-1"></div>
                                      ...
                                      • Después que el alumno haya aplicado la actividad de congelar un curso en que se encuentre activo, perderá el privilegio del uso de transferencia de su cupo a otra persona durante la etapa que ha sido congelada su clase grupal.</p>

                                      <div class="f-18 f-700">30. Canje de servicio</div><br>

                                      <p>Todo integrante inscrito en <b>Tu Clase de Baile</b>, tendrá la posibilidad de solicitar un canje de su paquete o servicio que haya sido obtenido por gestión de pago, este podrá ser aplicado siempre y cuando no le haya brindado el uso del mismo, en dicho caso la organización brinda la oportunidad de canjear el servicio a otra línea que ofrezca la academia, si por el contrario el participante haya dado inicio a sus clases o actividades el servicio de canje no será válido.</p>
