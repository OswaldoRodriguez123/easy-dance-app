            ...
            <section id="content">
                <div class="container">
                    ...
                    <div class="block-header">
                        <a class="btn-blanco m-r-10 f-16" href="{{url('/')}}/configuracion/productos" onclick="procesando()"> <i class="zmdi zmdi-chevron-left zmdi-hc-fw"></i> Sección Productos</a>
                          ...
                          <div class="clearfix p-b-35"></div>
                               ...
                               <div class="col-sm-12">
                                 <div class="form-group fg-line">
                                    <label for="descripcion" id="id-descripcion">Descripcion</label><i class="p-l-5 tm-icon zmdi zmdi-help ayuda mousedefault" data-trigger="hover" data-toggle="popover" data-placement="right" data-content="Ingresa las caracteristicas del producto que ofreces a tus clientes" title="" data-original-title="Ayuda"></i>
                                    <div class="fg-line">
...
<script type="text/javascript">
  ...
  route_agregar="{{url('/')}}/configuracion/productos/agregar";
