...
@section('content')
            ...
            <div class="modal fade" id="modalNombre-Paquete" tabindex="-1" role="dialog" aria-hidden="true">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer p-b-20 m-b-20">
                            ...
                            <div class="col-sm-12">                            
                              ...
                              <a class="btn-blanco m-r-5 f-12 guardar" href="#" id="guardar" data-formulario="edit_nombre_paquete" data-update="nombre" >  Guardar <i class="zmdi zmdi-chevron-right zmdi-hc-fw"></i></a>
            ...
            <div class="modal fade" id="modalCosto-Paquete" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-sm">
                    <div class="modal-content">
                        <div class="modal-header bg-gris-oscuro p-t-10 p-b-10">
                            <h4 class="modal-title c-negro"><i class="zmdi zmdi-edit m-r-5"></i> Editar Paquete de Clases<button type="button" data-dismiss="modal" class="close c-gris f-25" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button></h4>
                           ...
                           <div class="row p-t-20 p-b-0">
                               <div class="col-sm-12">
                                 <div class="form-group fg-line">
                                    ...
                                    <input type="text" class="form-control input-sm input-mask" name="costo" id="costo" data-mask="00000000" placeholder="Ej. 5000" value="{{$paquete->costo}}">
                                 </div>
                        ...
                        <div class="modal-footer p-b-20 m-b-20">
                            ...
                            <div class="col-sm-12">                            
                              ...
                              <a class="btn-blanco m-r-5 f-12 guardar" href="#" id="guardar" data-formulario="edit_costo_paquete" data-update="costo" >  Guardar <i class="zmdi zmdi-chevron-right zmdi-hc-fw"></i></a>
            ...
            <div class="modal fade" id="modalCantidad-Paquete" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-sm">
                    <div class="modal-content">
                        <div class="modal-header bg-gris-oscuro p-t-10 p-b-10">
                            <h4 class="modal-title c-negro"><i class="zmdi zmdi-edit m-r-5"></i> Editar Paquete de Clases<button type="button" data-dismiss="modal" class="close c-gris f-25" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button></h4>
                        ...
                        <form name="edit_cantidad_paquete" id="edit_cantidad_paquete"  >
                           ...
                           <div class="row p-t-20 p-b-0">
                               <div class="col-sm-12">
                                 <div class="form-group fg-line">
                                    <label for="costo">Cantidad de Clases</label>
                                    <input type="text" class="form-control input-sm input-mask" name="cantidad_clases_grupales" id="cantidad_clases_grupales" data-mask="00000000" placeholder="Ej. 5000" value="{{$paquete->cantidad_clases_grupales}}">
                                 </div>
                                 <div class="has-error" id="error-cantidad_clases_grupales">
                                      <span >
                                          <small class="help-block error-span" id="error-cantidad_clases_grupales_mensaje" ></small>                                
                                      </span>
                                  </div>
                               </div>
                        ...
                        <div class="modal-footer p-b-20 m-b-20">
                            ...
                            <div class="col-sm-12">                            
                              ...
                              <a class="btn-blanco m-r-5 f-12 guardar" href="#" id="guardar" data-formulario="edit_cantidad_paquete" data-update="cantidad" >  Guardar <i class="zmdi zmdi-chevron-right zmdi-hc-fw"></i></a>
            ...
            <div class="modal fade" id="modalDescripcion-Paquete" tabindex="-1" role="dialog" aria-hidden="true">
                    ...
                    <div class="modal-content">
                           ...
                           <div class="row p-t-20 p-b-0">
                               <div class="col-sm-12">
                                 <div class="form-group fg-line">
                                    ...
                                    <div class="fg-line">
                                      <textarea class="form-control" id="descripcion" name="descripcion" rows="8" placeholder="2000 Caracteres" maxlength="2000" onkeyup="countChar(this)">{{$paquete->descripcion}}</textarea>
                                    </div>
                        ...
                        <div class="modal-footer p-b-20 m-b-20">
                            ...
                            <div class="col-sm-12">                            
                              ...
                              <a class="btn-blanco m-r-5 f-12 guardar" href="#" id="guardar" data-formulario="edit_descripcion_paquete" data-update="descripcion" >  Guardar <i class="zmdi zmdi-chevron-right zmdi-hc-fw"></i></a>
            ...
            <div class="modal fade" id="modalImagen-Paquete" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header bg-gris-oscuro p-t-10 p-b-10">
                            <h4 class="modal-title c-negro"><i class="zmdi zmdi-edit m-r-5"></i> Editar Paquete de Clases<button type="button" data-dismiss="modal" class="close c-gris f-25" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button></h4>
                                ...
                                <div class="form-group text-center">
                                    <div class="form-group fg-line">
                                        ...
                                        <div id="imagena" class="fileinput-preview thumbnail" data-trigger="fileinput">
                                          @if($paquete->imagen)
                                          <img src="{{url('/')}}/assets/uploads/paquete/{{$paquete->imagen}}" style="line-height: 150px;">
                                          @endif
                                        </div>
                                        <div>
                        ...
                        <div class="modal-footer p-b-20 m-b-20">
                            ...
                            <div class="col-sm-12">                            
                              ...
                              <a class="btn-morado m-r-5 f-12 guardar" id="guardar" href="#" data-formulario="edit_imagen_paquete" data-update="imagen" >  Guardar <i class="zmdi zmdi-chevron-right zmdi-hc-fw"></i></a>
            ...
            <section id="content">
                <div class="container">
                    ...
                    <div class="block-header">
                       <a class="btn-blanco m-r-10 f-16" href="{{url('/')}}/paquetes" onclick="procesando()"> <i class="zmdi zmdi-chevron-left zmdi-hc-fw"></i> Sección Paquetes de Clases</a>
                            ...
                            <div class="text-center p-t-30">       
                              <div class="row p-b-15 ">
                                <div class="col-md-12" data-src="/assets/img/ayuda-configuracion.jpg">
                                  ...
                                  <i class="zmdi zmdi-delete boton red f-20 m-r-10 boton red sa-warning" id="{{$paquete->id}}" name="eliminar" data-original-title="Eliminar" data-toggle="tooltip" data-placement="bottom" title=""></i>
                         ...
                         <div class="col-sm-12">
                          ...
                          <div class="col-sm-12">
                           <table class="table table-striped table-bordered">
                            <tr class="detalle" data-toggle="modal" href="#modalNombre-Paquete">
                             <td>
                               <span  class="m-l-10 m-r-5 f-16" ><i id="estatus-nombre" class="zmdi {{ empty($paquete->nombre) ? 'c-amarillo zmdi-dot-circle' : 'c-verde zmdi-check' }} zmdi-hc-fw"></i></span>
                               <span class="m-l-10 m-r-10"> <i class="icon_a-paquete f-22"></i> </span>
                               <span class="f-14"> Nombre </span>
                             </td>
                             <td class="f-14 m-l-15" ><span id="paquete-nombre" class="capitalize">{{$paquete->nombre}}</span> <span class="pull-right c-blanco"><i class="zmdi zmdi-edit f-22"></i></span> </td>
                            </tr>
                            <tr class="detalle" data-toggle="modal" href="#modalCosto-Paquete">
                             <td>
                               <span  class="m-l-10 m-r-5 f-16" ><i id="estatus-costo" class="zmdi {{ empty($paquete->costo) ? 'c-amarillo zmdi-dot-circle' : 'c-verde zmdi-check' }} zmdi-hc-fw"></i></span>
                               <span class="m-l-10 m-r-10"> <i class="icon_b icon_b-costo f-22"></i> </span>
                               <span class="f-14"> Costo </span>
                             </td>
                             <td class="f-14 m-l-15" ><span id="paquete-costo"><span>{{ number_format($paquete->costo, 2, '.' , '.') }}</span></span> <span class="pull-right c-blanco"><i class="zmdi zmdi-edit f-22"></i></span> </td>
                            </tr>
                            <tr class="detalle" data-toggle="modal" href="#modalCantidad-Paquete">
                             <td>
                               <span  class="m-l-10 m-r-5 f-16" ><i id="estatus-cantidad_clases_grupales" class="zmdi {{ empty($paquete->cantidad_clases_grupales) ? 'c-amarillo zmdi-dot-circle' : 'c-verde zmdi-check' }} zmdi-hc-fw"></i></span>
                               <span class="m-l-10 m-r-10"> <i class="icon_b icon_b-costo f-22"></i> </span>
                               <span class="f-14"> Cantidad de Clases</span>
                             </td>
                             <td class="f-14 m-l-15" ><span id="paquete-cantidad_clases_grupales"><span>{{$paquete->cantidad_clases_grupales}}</span></span> <span class="pull-right c-blanco"><i class="zmdi zmdi-edit f-22"></i></span> </td>
                            </tr>
                            <tr class="detalle" data-toggle="modal" href="#modalDescripcion-Paquete">
                             <td>
                               <span  class="m-l-10 m-r-5 f-16" ><i id="estatus-descripcion" class="zmdi {{ empty($paquete->descripcion) ? 'c-amarillo zmdi-dot-circle' : 'c-verde zmdi-check' }} zmdi-hc-fw"></i></span>
                               <span class="m-l-10 m-r-10"> <i class="icon_b-cuentales-historia f-22"></i> </span>
                               <span class="f-14"> Descripción </span>
                             </td>
                             <td id="paquete-descripcion" class="f-14 m-l-15" data-valor="{{$paquete->descripcion}}" ><span ><span>{{ str_limit($paquete->descripcion, $limit = 30, $end = '...') }}</span></span> <span class="pull-right c-blanco"><i class="zmdi zmdi-edit f-22"></i></span> </td>
                            </tr>
                            <tr class="detalle" data-toggle="modal" href="#modalImagen-Paquete">
                             <td>
                               <span  class="m-l-10 m-r-5 f-16" ><i id="estatus-imageBase64" class="zmdi {{ empty($paquete->imagen) ? 'c-amarillo zmdi-dot-circle' : 'c-verde zmdi-check' }} zmdi-hc-fw"></i></span>
...
@section('js') 
   <script type="text/javascript">
    route_update="{{url('/')}}/paquetes/update";
    route_eliminar="{{url('/')}}/paquetes/eliminar/";
    route_principal="{{url('/')}}/paquetes";
    ...
    $('#modalNombre-Paquete').on('show.bs.modal', function (event) {
      limpiarMensaje();
      $("#nombre").val($("#paquete-nombre").text()); 
    })

    $('#modalDescripcion-Paquete').on('show.bs.modal', function (event) {
      limpiarMensaje();
       var descripcion=$("#paquete-descripcion").data('valor');
      ...
      function campoValor(form){
        $.each(form, function (n, c) {
          if(c.name=='tipo_uso'){
            ...
            $("#paquete-"+c.name).text(formatmoney(parseFloat(c.value)));
          }else{
            $("#paquete-"+c.name).text(c.value);
          }
