                            ...
                            <div class="clearfix p-b-15"></div>
                              <div class="col-sm-12">
                               ...
                               <div class="col-sm-12">
                                <div class="form-group">
                                    <div class="form-group">
                                        <label for="costo" id="id-costo">Costo</label> <i class="p-l-5 tm-icon zmdi zmdi-help ayuda mousedefault" data-trigger="hover" data-toggle="popover" data-placement="right" data-content="Ingresa el costo del paquete" title="" data-original-title="Ayuda"></i>
                               ...
                               <div class="col-sm-12">
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <span class="input-group-addon"><i class="icon_b icon_b-costo f-22"></i></span>
                                        <div class="fg-line">
                                        <input type="text" class="form-control input-sm input-mask" name="cantidad_clases_grupales" id="cantidad_clases_grupales" data-mask="00000000" placeholder="Ej. 15">
                                        </div>
                                      </div>
                                    </div>
                                    <div class="has-error" id="error-cantidad_clases_grupales">
                                      <span >
                                          <small id="error-cantidad_clases_grupales_mensaje" class="help-block error-span" ></small>                                           
                                      </span>
                                    </div>
                                </div>
                               </div>
...
<script type="text/javascript">
  ...
  route_agregar="{{url('/')}}/paquetes/agregar";
  ...
  function notify(from, align, icon, type, animIn, animOut, mensaje, titulo){
      ...
      $( "#cancelar" ).click(function() {
        ...
        limpiarMensaje();
        $('html,body').animate({
        scrollTop: $("#id-paquete").offset().top-90,
        }, 1500);
        $("#nombre").focus();
      });
