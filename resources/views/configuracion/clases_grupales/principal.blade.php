...
<a href="{{url('/')}}/configuracion/clases-grupales/agregar" class="btn bgm-green btn-float waves-effect m-btn"><i class="zmdi zmdi-plus"></i></a>
                           ...
                           <div class="col-md-12">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center" data-column-id="costo_inscripcion" data-type="numeric">Costo Inscripcion</th>
                                    <th class="text-center" data-column-id="costo_mensualidad" data-type="numeric">Costo Mensualidad</th>
                                    <th class="text-center" data-column-id="operacion" data-order="desc" >Acciones</th>
                                </tr>
                            </thead>
                            <tbody>

                            @foreach ($clases_grupales as $clases)
                                <?php $id = $clases['id']; ?>
                                <tr id="row_{{$id}}" class="seleccion" >
                                    <td class="text-center previa">{{$clases['nombre']}}</td>
                                    <td class="text-center previa">{{$clases['costo_inscripcion']}} </td>
                                    <td class="text-center previa">{{$clases['costo_mensualidad']}} </td>
...
@section('js') 
        ...
        route_detalle="{{url('/')}}/configuracion/clases-grupales/detalle";
