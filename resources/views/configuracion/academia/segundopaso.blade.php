            ...
            <section id="content">
                <div class="container">
                    ...
                    <div class="card">
                        ...
                        <form name="agregar" method="POST" action="{{url('/')}}/configuracion/carga-inicial/contacto">
                               ...
                               <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                 <div class="form-group fg-line">
                                    ...
                                    <input type="text" class="form-control input-sm" name="imagen" id="imagen" placeholder="">
                                 </div>
                               </div>
