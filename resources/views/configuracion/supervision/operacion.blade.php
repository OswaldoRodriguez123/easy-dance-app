...
<section id="content">
        <div class="container">
           <div class="block-header">
                ...
                <a class="btn-blanco m-r-10 f-16" href="{{url('/')}}/configuracion/staff" > <i class="zmdi zmdi-chevron-left zmdi-hc-fw"></i> Sección Staff</a>
                </div>

                <div class="col-sm-6 text-right">
                <a class="btn-blanco m-r-10 f-16" style="text-align: right" href="{{url('/')}}/configuracion/staff/detalle/{{$id}}"> Vista Previa <i class="zmdi zmdi-chevron-right zmdi-hc-fw"></i></a>
                </div>
            </div> 
