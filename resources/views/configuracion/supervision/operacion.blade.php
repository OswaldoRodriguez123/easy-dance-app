...
<section id="content">
        <div class="container">
           <div class="block-header">
                ...
                <a class="btn-blanco m-r-10 f-16" href="{{url('/')}}/configuracion/supervisiones" > <i class="zmdi zmdi-chevron-left zmdi-hc-fw"></i> Sección Configuración</a>
                </div>

                <div class="col-sm-6 text-right">
                <a class="btn-blanco m-r-10 f-16" style="text-align: right" href="{{url('/')}}/configuracion/supervisiones/detalle/{{$id}}"> Vista Previa <i class="zmdi zmdi-chevron-right zmdi-hc-fw"></i></a>
                </div>
            </div> 
            ...
            <h4 class ="c-morado text-right">Cargo: {{$config_supervision->cargo}}</h4>
            ...
            <ul class="ca-menu-c" style="width: 500px;">
                    <li data-ripplecator class ="dark-ripples">
                        <a class = "agregar">
                            <span class="ca-icon-c"><i class="zmdi zmdi-plus f-35 boton blue sa-warning" 
                                   data-original-title="Agregar" data-toggle="tooltip" data-placement="bottom" title=""></i></span>
                            <div class="ca-content-c">
                                <h2 class="ca-main-c">Agregar</h2>
...
@section('js') 
  ...
  $(".eliminar").click(function(){
    ...
    $(".agregar").click(function(){
        ...
        window.location = "{{url('/')}}/configuracion/supervisiones/procedimientos/{{$id}}";
