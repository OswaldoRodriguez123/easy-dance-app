...
@section('content')
            ...
            -->  
            <div class="modal fade" id="modalDescripcion-Supervision" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <form name="edit_descripcion_supervision" id="edit_descripcion_supervision"  >
                           ...
                           <div class="row p-t-20 p-b-0">
                               <div class="col-sm-12">
                                <div class="form-group">
                                 <div class="form-group fg-line">
                                    ...
                                    <div class="fg-line">
                                      <textarea class="form-control" id="descripcion" name="descripcion" rows="8" placeholder="2000 Caracteres" maxlength="2000" onkeyup="countChar(this)">{{$config_supervision->descripcion}}</textarea>
                                    </div>
                               ...
                               <input type="hidden" name="id" value="{{$config_supervision->id}}"></input>
                        ...
                        <div class="modal-footer p-b-20 m-b-20">
                            ...
                            <div class="col-sm-12">                            
                              ...
                              <a class="btn-blanco m-r-5 f-12 guardar" href="#" id="guardar" data-formulario="edit_descripcion_supervision" data-update="descripcion" >  Guardar <i class="zmdi zmdi-chevron-right zmdi-hc-fw"></i></a>
                    ...
                    <div class="modal-content">
                        ...
                        <form name="edit_cargo_supervision" id="edit_cargo_supervision"  >
                           ...
                           <div class="row p-t-20 p-b-0">
                               <div class="col-sm-12">
                                 ...
                                 <div class="has-error" id="error-cargo_id">
                                      <span >
                                          <small class="help-block error-span" id="error-cargo_id_mensaje" ></small>                                
                                      </span>
                                  </div>
                               </div>
                        ...
                        <div class="modal-footer p-b-20 m-b-20">
                            ...
                            <div class="col-sm-12">          
                              ...
                              <a class="btn-blanco m-r-5 f-12 guardar" href="#" id="guardar" data-formulario="edit_cargo_supervision" data-update="cargo" >  Guardar <i class="zmdi zmdi-chevron-right zmdi-hc-fw"></i></a>
                            ...
                            <div class="text-center p-t-30">       
                              <div class="row p-b-15 ">
                                <div class="col-md-12" data-src="/assets/img/ayuda-configuracion.jpg">
                                  ...
                                  <a href="{{url('/')}}/configuracion/supervisiones/procedimientos/{{$id}}"><i class="zmdi zmdi-plus f-20 m-r-10 boton blue sa-warning"  data-original-title="Agregar" data-toggle="tooltip" data-placement="bottom" title=""></i></a>
                                  <i class="zmdi zmdi-delete boton red f-20 m-r-10 boton red sa-warning" id="{{$config_supervision->id}}" name="eliminar" data-original-title="Eliminar" data-toggle="tooltip" data-placement="bottom" title=""></i>
                         ...
                         <div class="col-sm-12">
                          ...
                          <div class="col-sm-12">
                           ...
                           <tr class="detalle" data-toggle="modal" href="#modalCargo-Supervision">
                             <td>
                               <span  class="m-l-10 m-r-5 f-16" ><i id="estatus-cargo_id" class="zmdi {{ empty($config_supervision->cargo) ? 'c-amarillo zmdi-dot-circle' : 'c-verde zmdi-check' }} zmdi-hc-fw"></i></span>
                               <span class="m-l-10 m-r-10"> <i class="icon_f-staff f-22"></i> </span>
                               <span class="f-14"> Cargo </span>
                             </td>
                             <td class="f-14 m-l-15" ><span id="supervision-cargo_id" class="capitalize"><span>{{$config_supervision->cargo}}</span></span> <span class="pull-right c-blanco"><i class="zmdi zmdi-edit f-22"></i></span> </td>
                            </tr>
                            <tr class="detalle" data-toggle="modal" href="#modalDescripcion-Supervision">
                             <td>
                               <span  class="m-l-10 m-r-5 f-16" ><i id="estatus-descripcion" class="zmdi {{ empty($config_supervision->descripcion) ? 'c-amarillo zmdi-dot-circle' : 'c-verde zmdi-check' }} zmdi-hc-fw"></i></span>
                               <span class="m-l-10 m-r-10"> <i class="icon_b-cuentales-historia f-22"></i> </span>
                               <span class="f-14"> Descripcion </span>
                             </td>
                             <td id="supervision-descripcion" class="f-14 m-l-15 capitalize" data-valor="{{$config_supervision->descripcion}}" >{{ str_limit($config_supervision->descripcion, $limit = 30, $end = '...') }} <span class="pull-right c-blanco"><i class="zmdi zmdi-edit f-22"></i></span> </td>
                            </tr>
...
@section('js') 
  <script type="text/javascript">
    ...
    function limpiarMensaje(){
        var campo = ["cargo_id", "descripcion"];
        fLen = campo.length;
        for (i = 0; i < fLen; i++) {
        ...
        $.each(form, function (n, c) {
          if(c.name=='cargo_id'){
            ...
            //$("#alumno-"+c.name).text(c.value.substr(0, 30));
             ...
             $("#supervision-"+c.name).data('valor',c.value);
             $("#supervision-"+c.name).html(c.value.toLowerCase().substr(0, 30) + "...");
            //$("#alumno-"+c.name).text(c.value.substr(0, 30));
          }else{
            $("#supervision-"+c.name).text(c.value.toLowerCase());
          }
