...
@section('content')
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bg-gris-oscuro p-t-10 p-b-10">
                    <h4 class="modal-title c-negro"><i class="zmdi zmdi-edit m-r-5"></i> Agregar Normativa<button type="button" data-dismiss="modal" class="close c-gris f-25" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button></h4>
                </div>
                    ...
                    <div class="row p-t-20 p-b-0">
                        <form name="form_agregar" id="form_agregar"  >
                            ...
                            <div class="col-sm-12">
                                ...
                                <label for="nombre" id="id-nombre">Nombre</label> <i class="p-l-5 tm-icon zmdi zmdi-help ayuda mousedefault" data-trigger="hover" data-toggle="popover" data-placement="right" data-content="Ingresa el nombre de la normativa" title="" data-original-title="Ayuda"></i>

                                <div class="input-group">
                                    <span class="input-group-addon"><i class="icon_a-tutoriales f-22"></i></span>
                                    <div class="fg-line">
                                        <input type="text" class="form-control input-sm proceso" name="nombre" id="nombre" placeholder="Ej. Clases Grupales">
                                    </div>
                                </div>
    ...
    <div class="modal fade" id="modalActualizar" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bg-gris-oscuro p-t-10 p-b-10">
                    <h4 class="modal-title c-negro"><i class="zmdi zmdi-edit m-r-5"></i> Actualizar Normativa<button type="button" data-dismiss="modal" class="close c-gris f-25" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button></h4>
                </div>
                <div class="modal-body">                           
                    <div class="row p-t-20 p-b-0">
                        <form name="form_actualizar" id="form_actualizar"  >
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="has-error" id="error-pdf2">
                                  <span >
                                    <small id="error-pdf2_mensaje" class="help-block error-span" ></small>                      
                                  </span>
                                </div>
                ...
                <div class="modal-footer p-b-20 m-b-20">
                    ...
                    <div class="col-sm-12">                            
                          ...
                          <a class="btn-blanco m-r-5 f-12 pointer" id="actualizar">  Actualizar <i class="zmdi zmdi-chevron-right zmdi-hc-fw"></i></a>
                ...
                <div class="container">
                    ...
                    <div class="card">
                        <div class="card-header text-right">
                            ...
                            <span class="f-16 p-t-0 text-success">Agregar una Normativa <i class="p-l-5 zmdi zmdi-arrow-right zmdi-hc-fw f-25 "></i></span>

                            <br><br><p class="text-center opaco-0-8 f-22"><i class="icon_a-tutoriales f-25"></i> Sección de Normativas</p>
...
@section('js') 
    ...
    <script type="text/javascript">
        ...
        route_agregar = "{{url('/')}}/configuracion/herramientas/normativas/agregar";
        route_actualizar = "{{url('/')}}/configuracion/herramientas/normativas/actualizar";
        route_eliminar = "{{url('/')}}/configuracion/herramientas/normativas/eliminar/";
        ...
        $(document).ready(function(){
            ...
            t=$('#tablelistar').DataTable({
                ...
                fnRowCallback: function( nRow, aData, iDisplayIndex, iDisplayIndexFull ) {
                  ...
                  $('td:eq(0)', nRow).attr( "onclick","previa(this)" );
                },
                language: {
        ...
        $('#tablelistar tbody').on( 'click', 'i.zmdi-delete', function () {
            ...
            swal({   
                title: "Desea eliminar la normativa?",   
         ...
         procesando();
                ...
                $.ajax({
                    ...
                    success:function(respuesta){
                        ...
                        swal("Exito!","La normativa ha sido eliminada!","success");
                        finprocesado();
        ...
        $("#guardar").click(function(){
            ...
            var nombre = $('#form_agregar').find('input[name="nombre"]').val();
        ...
        function previa(t){
            ...
            $('#form_actualizar').find('input[name="id"]').val(id);
            $('#form_actualizar').find('input[name="nombre"]').val(nombre);
        ...
        $("#actualizar").click(function(){
            ...
            var token = $('input:hidden[name=_token]').val();
            var datos = new FormData();
            var id = $('#form_actualizar').find('input[name="id"]').val();
            var nombre = $('#form_actualizar').find('input[name="nombre"]').val();
            var pdf = document.getElementById('pdf2');
            datos.append('id', id);
            datos.append('nombre', nombre);
            
            if(pdf.files[0])
            {
              datos.append('pdf2', pdf.files[0]);
            }
                ...
                success:function(respuesta){
                    setTimeout(function(){ 
                        ...
                        if(respuesta.status=="OK"){
                            ...
                            var rowId=respuesta.normativa.id;
                             $("#"+rowId).closest('tr').find('td:eq(0)').text(respuesta.normativa.nombre);
                            finprocesado();
