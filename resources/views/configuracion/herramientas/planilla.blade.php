                        ...
                        <div class="container">
                         ...
                         <div class="col-sm-12">
                          ...
                          <div class="col-sm-12">
                            ...
                            <tr class="detalle normativas">
                             <td>
                               <span  class="m-l-10 m-r-5 f-16" ><i class="zmdi c-verde zmdi-check zmdi-hc-fw"></i></span>
                               <span class="m-l-10 m-r-10">  <i class="icon_a-tutoriales f-22"></i> </span>
                               <span class="f-14"> Normativas </span>
                             </td>
                             <td class="f-14 m-l-15" > <span class="pull-right c-blanco"><i class="zmdi zmdi-edit f-22"></i></span> </td>
                            </tr> 

                            <tr class="detalle correos">
                             <td>
                               <span  class="m-l-10 m-r-5 f-16" ><i class="zmdi c-verde zmdi-check zmdi-hc-fw"></i></span>
                               <span class="m-l-10 m-r-10">  <i class="zmdi zmdi-email f-22"></i> </span>
                               <span class="f-14"> Correos </span>
                             </td>
                             <td class="f-14 m-l-15" > <span class="pull-right c-blanco"><i class="zmdi zmdi-edit f-22"></i></span> </td>
                            </tr> 

                            <tr class="detalle sms">
                             <td>
                               <span  class="m-l-10 m-r-5 f-16" ><i class="zmdi c-verde zmdi-check zmdi-hc-fw"></i></span>
                               <span class="m-l-10 m-r-10">  <i class="zmdi zmdi-smartphone f-22"></i> </span>
                               <span class="f-14"> Mensajes </span>
                             </td>
                             <td class="f-14 m-l-15" > <span class="pull-right c-blanco"><i class="zmdi zmdi-edit f-22"></i></span> </td>
                            </tr> 

                            <tr class="detalle pasos">
                             <td>
                               <span  class="m-l-10 m-r-5 f-16" ><i class="zmdi c-verde zmdi-check zmdi-hc-fw"></i></span>
                               <span class="m-l-10 m-r-10">  <i class="icon_a-tutoriales f-22"></i> </span>
                               <span class="f-14"> Pasos </span>
                             </td>
                             <td class="f-14 m-l-15" > <span class="pull-right c-blanco"><i class="zmdi zmdi-edit f-22"></i></span> </td>
                            </tr>
                            <tr class="detalle actividad">
                             <td>
                               ...
                               <span class="f-14"> Actividades Laborales </span>
                             </td>
                             <td class="f-14 m-l-15" ><span class="pull-right c-blanco"><i class="zmdi zmdi-edit f-22"></i></span> </td>
                            </tr>
...
@section('js') 
  ...
  var h=$('#tableestudio').DataTable({
      ...
      var a=$('#tableactividad').DataTable({
        processing: true,
        serverSide: false, 
        bPaginate: false, 
        bFilter:false, 
    ...
    function limpiarMensaje(){
        var campo = ["nombre_cargo", "nombre_estudio", "nombre_formula", "nombre_nivel", "nombre_puntaje", "nombre_supervision", "nombre_valoracion", "cargo_supervision","nombre_actividad","descripcion_actividad"];
        fLen = campo.length;
        for (i = 0; i < fLen; i++) {
    ...
    $(".normativas").click(function(){
      procesando();
      window.location = "{{url('/')}}/configuracion/herramientas/normativas";
    });
    ...
    $(".ocupacion").click(function(){
      procesando();
      window.location = "{{url('/')}}/configuracion/herramientas/ocupaciones";
    });
