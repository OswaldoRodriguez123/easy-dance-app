                ...
                <div class="container">
                    ...
                    <div class="card">
                        ...
                        <div class="col-md-1"></div>
                            ...
                            <div class="f-700 f-30 text-center">HÁBLALE A TUS AMIGOS DE LA ACADEMIA <b>{{$academia}}</b> Y ACUMULA PUNTOS</div>
                            ...
                            <div class="clearfix p-b-35"></div>
                                    ...
                                    <form name="formComparte" id="formComparte" class="">
                                        ...
                                        <div class="col-sm-6">
                                            <label id="id-nombre">Ingresa el nombre </label> <i class="p-l-5 tm-icon zmdi zmdi-help ayuda mousedefault" data-trigger="hover" data-toggle="popover" data-placement="right" data-content="Ingresa el nombre de la persona a la que desear recomendar la academia" title="" data-original-title="Ayuda"></i>   
                                        ...
                                        <div class="col-sm-6">
                                            <label id="id-correo">Ingresa su correo electrónico </label> <i class="p-l-5 tm-icon zmdi zmdi-help ayuda mousedefault" data-trigger="hover" data-toggle="popover" data-placement="right" data-content="Ingresa el correo electrónico  de la persona a la que desear recomendar la academia" title="" data-original-title="Ayuda"></i>   
                                            <div class="input-group input-group-lg">
