...
<div bgcolor="#efefef" style="background:#efefef"><div class="adM">
      ...
      <tr>
                                <td valign="top" style="text-align:center;">
                                  <font style="font-family:'HelveticaNeue',Arial,Helvetica,sans-serif;font-size:16px;line-height:18px;color:#000000;font-weight:bold;"> HAS RESERVADO UNA CLASE PERSONALIZADA <br><br>
                                  </font>
                              </td></tr><tr>
      </tr><tr>
                                <td valign="top">
                                  <font style="font-family:'HelveticaNeue',Arial,Helvetica,sans-serif;font-size:13px;line-height:18px;color:#000000">
                                    Hola <b> {{$nombre_alumno}} </b> Has reservado una Clase personalizada dirigida por <b>{{$nombre_instructor}} {{$apellido_instructor}}</b> para la Fecha del <b>{{$fecha}}</b> desde las <b>{{$hora_inicio}}</b> hasta las <b>{{$hora_final}}</b> en la academia <b>{{$academia}}</b>. Por favor espera a que la academia confirme tu reservacion.
