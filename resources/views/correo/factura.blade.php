                        ...
                        <tbody><tr>
                          ...
                          <td valign="top" width="510">
                            <table border="0" cellpadding="0" cellspacing="0" width="510">
                              ...
                              <tr>
                                <td align="center" valign="top"> <a href="{{url('/')}}/inicio" alt="Pocket-logo-email-original" src="http://oi64.tinypic.com/2ajtm4l.jpg" width="120"></a>
                                </td>
                              </tr>
                              ...
                              <tr>
                                <td align="center" valign="top"><img class="CToWUd" alt="Pocket-logo-email-original" src="http://oi65.tinypic.com/348hawl.jpg" height="200" width="570">
                                </td>
                              </tr>
			<tr>
                              <tr>
                                ...
                                <td valign="top" style="text-align:center;">
                                  <font style="font-family:'HelveticaNeue',Arial,Helvetica,sans-serif;font-size:22px;line-height:18px;color:#000000;font-weight:bold;"> Pago realizado exitósamente <br><br>
                                  </font>
                              </td></tr><tr></tr>                  
                              ...
                              <tr>
                                <td valign="top">
                                  <font style="font-family:'HelveticaNeue',Arial,Helvetica,sans-serif;font-size:13px;line-height:18px;color:#000000">
                                    <b style=" padding-left: 10px">Datos de la academia</b>
                                    <p style="font-size:3px" height="20"></p>
                                    <span style=" padding-left: 10px">Nombre: {{$nombre}}<br></span> 
                                    <span style=" padding-left: 10px">Telefono: {{$telefono}}<br></span>
                                    <span style=" padding-left: 10px">Correo electrónico: {{$correo}}<br></span>
                                ...
                                <tr>
                                  <td valign="top">
                                    <font style="font-family:'HelveticaNeue',Arial,Helvetica,sans-serif;font-size:13px;line-height:18px;color:#000000">
                                      <span style=" padding-left: 10px"><b>Información de pago</b></span>
                                      <p style="font-size:3px" height="20"></p>
                                      <span style=" padding-left: 10px">Fecha: {{$fecha}}<br></span>
                                      <span style=" padding-left: 10px">Hora: {{$hora}}<br></span>
                                      <span style=" padding-left: 10px">Número de Factura: {{$factura}}<br></span>
                                      <span style=" padding-left: 10px">Total: {{$total}}<br></span>
                                      <span style=" padding-left: 10px">Descripción: {{$descripcion}}<br></span>
