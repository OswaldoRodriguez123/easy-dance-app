...
<div bgcolor="#efefef" style="background:#efefef"><div class="adM">
      ...
      <tr>
                                <td valign="top" style="text-align:center;">
                                  <font style="font-family:'HelveticaNeue',Arial,Helvetica,sans-serif;font-size:16px;line-height:18px;color:#000000;font-weight:bold;"> HAN REALIZADO UNA RESERVACIÓN <br><br>
                                  </font>
                              </td></tr><tr>
      </tr><tr>
                                <td valign="top">
                                  <font style="font-family:'HelveticaNeue',Arial,Helvetica,sans-serif;font-size:13px;line-height:18px;color:#000000">
                                    ...
                                    El participante <b> {{$nombre}} </b> ha reservado <b>{{$actividad}} {{$actividad_nombre}}</b>. <br>

                                    te invitamos a ponerte en contacto con el en los siguientes contactos:
