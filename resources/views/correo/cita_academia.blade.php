...
<div bgcolor="#efefef" style="background:#efefef"><div class="adM">
      ...
      <tr>
                                <td valign="top" style="text-align:center;">
                                  <font style="font-family:'HelveticaNeue',Arial,Helvetica,sans-serif;font-size:16px;line-height:18px;color:#000000;font-weight:bold;"> HAN RESERVADO UNA CITA <br><br>
                                  </font>
                              </td></tr><tr>
      </tr><tr>
                                <td valign="top">
                                  <font style="font-family:'HelveticaNeue',Arial,Helvetica,sans-serif;font-size:13px;line-height:18px;color:#000000">
                                    El alumno <b> {{$nombre_alumno}} {{$apellido_alumno}} </b> con la identificacion <b> {{$cedula}} </b> ha reservado una Cita, solicitando al instructor <b>{{$nombre_instructor}} {{$apellido_instructor}}</b> para la Fecha del <b>{{$fecha}}</b> desde las <b>{{$hora_inicio}}</b> hasta las <b>{{$hora_final}}</b>. Comunicate con el para confirmar su reservacion.
