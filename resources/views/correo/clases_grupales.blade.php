...
<body>
<div bgcolor="#efefef" style="background:#efefef"><div class="adM">
    </div><table style="table-layout:fixed" bgcolor="#efefef" border="0" cellpadding="0" cellspacing="0" width="100%">
      <tbody><tr>
        <td valign="top">
			...
			<tr>
                                ...
                                <td valign="top">
                                  <font style="font-family:'HelveticaNeue',Arial,Helvetica,sans-serif;font-size:13px;line-height:18px;color:#000000">
                                    Saludos, <b> {{$nombre}} </b> te enviamos la información de los próximos horarios en <b>Tu clase de baile</b>, te recordamos que nuestra clases son guiadas por profesores internacionales con más de 10 años de experiencia y que nuestros cursos cuentan con la certificación de niveles, avalados por la organización internacional de Salsa Casino AZUCA.</font>
                                </td>
                              ...
                              <tr>
                                <td>
                                <font style="font-family:'HelveticaNeue',Arial,Helvetica,sans-serif;font-size:13px;line-height:18px;color:#000000"><b>Fechas de apertura para los próximas clases</b></font>
                                </td>
                              </tr>
                              ...
                              <tr>
                                <td valign="top">
                                  <font style="font-family:'HelveticaNeue',Arial,Helvetica,sans-serif;font-size:13px;line-height:18px;color:#000000">
                                    ...
                                    {{$clase_grupal->clase_grupal_nombre}}, {{$clase_grupal->instructor_nombre}} {{$clase_grupal->instructor_apellido}}, {{$clase_grupal->fecha_inicio}} <a style="color:#551a8b !important; font-weight: 700; text-decoration: none" href="http://app.easydancelatino.com/agendar/clases-grupales/progreso/{{$clase_grupal->id}}" target="_blank">
                                            Ver mas
                                        </a> <br>
                              ...
                              <tr>
                                <td valign="top" style="text-align:center;">
                                  <font style="font-family:'HelveticaNeue',Arial,Helvetica,sans-serif;font-size:16px;line-height:18px;color:#000000;font-weight:bold;"> Nuestro sistema de pago <br><br>
                                  </font>
                                </td>
                              </tr>
                              ...
                              <b>• Opción 1:</b> $ 55.000 Salsa casino + un ritmo adicional (Bachata o

                              Género Urbano) + $20.000 de Inscripción. <br><br>

                              <b>• Opción 2:</b> $ 70.000 Salsa casino + Bachata + Genero Urbano +

                              $20.000 de Inscripción.
                              ...
                              ¡Esperamos verte pronto en clases!
                            ...
                            <table style="height:57px;table-layout:fixed" border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tbody><tr>
                                    ...
                                    <td style="font-size:1px;line-height:1px;font-family:'Helvetica Neue',Helvetica,arial,sans-serif;color:#ffffff;text-align:left;height:57px;width:104px" align="left" valign="top">
                                        <a href="http://easydancelatino.com/" style="color:#ffffff;font-weight:normal;text-decoration:underline" target="_blank"><img class="CToWUd" alt="" src="http://easydancelatino.com/img/correos/logo_gris.png?v=2" style="width:104px;min-height:57px" border="0"></a>
                                    </td>
                                    ...
                                    <td style="font-size:1px;line-height:1px;font-family:'Helvetica Neue',Helvetica,arial,sans-serif;color:#ffffff;text-align:left;height:57px;width:29px" align="left" valign="top">
                                        <a href="http://easydancelatino.com/" style="color:#ffffff;font-weight:normal;text-decoration:underline" target="_blank">
...
<img class="CToWUd" src="https://ci6.googleusercontent.com/proxy/tej2lzuz6dl2dtdY55wnyW7ScCg4HOXiwbGWQC16h2RyCJdnWSws_z8Sb8tOwg71YPNsBgAZGOKolBSpmXgBt3TD-KfMO23zu9XHBCmL5hete4WFxvvEweiJ65EppiGQzRTJco-nqk709SR79Ph2Dzr8-AoJlyQFB6J09NH_hIgFdupH-PY24oIgsUhc_Mkm37-kYtsDMFAkEno7jq2hYL3Q77o35R42UIZrr_3I6T314dmyIGg-SeWCApYa9YKowQZl-foRbFrk3wHTUOueeqXFvjG0q2_S28_UEC2AORaGjgSPLUrGiF2FFdCCZIne88lK2S9lMSTvpTh5KarDRA0OhjefwXDWi6tl1gcHPWQBvL7nL--DFdOjs9Vfk1k8HxPwKNY4gPWaWnZdo7lSfS7FtwIRmkc03n0=s0-d-e1-ft#http://email.getpocket.com/wf/open?upn=lNWjQZ-2Fq7Mwk6zGP-2FaK4F6PNgZ5rWpFdCqA5766X-2BGMpwjt92c467oNM55-2B6729r9wq6d63mu8GHbuTj4GzQwsQZBIl-2BdzfN8P5wDDRyJqURLTGsP3yKkmqVdWsQGmLttsLoqCDiHVpLsLmWR9sQVAfa8aeij2BVKftzrb6h02oEwPguNYZAwbFV5pabTi2h5eNGEDdZtm9XesSQytUjlt-2BTsdidNNIKbKmYZJucP-2Fw-3D" alt="" style="min-height:1px!important;width:1px!important;border-width:0!important;margin-top:0!important;margin-bottom:0!important;margin-right:0!important;margin-left:0!important;padding-top:0!important;padding-bottom:0!important;padding-right:0!important;padding-left:0!important" height="1" border="0" width="1"><div class="yj6qo"></div><div class="adL">
</div></div>
</body>
</html>