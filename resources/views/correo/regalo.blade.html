        ...
        <td valign="top">
          <table align="center" bgcolor="#efefef" border="0" cellpadding="0" cellspacing="0" width="600">
			...
			<tr>
                            @if($imagen)
                              <tr>
                                <td align="center" valign="top"><img class="CToWUd" alt="Pocket-logo-email-original" src="{{url('/')}}/assets/uploads/regalo/{{$imagen}}" height="150" width="150">
                                </td>
                              </tr>
                            @endif
                                ...
                                <td valign="top" style="text-align:center;">
                                  <font style="font-family:'HelveticaNeue',Arial,Helvetica,sans-serif;font-size:16px;line-height:18px;color:#000000;font-weight:bold;"> <p>FELICIDADES, HAS RECIBIDO UNA TARJETA DE REGALO </p><br>
                                  </font>
                              </td></tr><tr>
			</tr><tr>
                                <td valign="top">
                                  <font style="font-family:'HelveticaNeue',Arial,Helvetica,sans-serif;font-size:13px;line-height:18px;color:#000000">
                                    Hola <b> {{$dirigido_a}} </b> , Has recibido una tarjeta de regalo de parte de <b>{{$de_parte_de}}</b> para que puedas disfrutarlo en la academia <b>{{$academia}}</b><br><br>

                                    Estos son los datos del regalo:

                                    <br><br>

                                    Nombre: {{$regalo_nombre}} <br>

                                    Costo: {{$costo}} <br>

                                    Codigo de validación: {{$codigo_validacion}} <br>
