          ...
          <table align="center" bgcolor="#efefef" border="0" cellpadding="0" cellspacing="0" width="600">
			...
			<tr>
                                <td valign="top" style="text-align:center;">
                                  <font style="font-family:'HelveticaNeue',Arial,Helvetica,sans-serif;font-size:16px;line-height:18px;color:#000000;font-weight:bold;"> FELICIDADES, HAS RECIBIDO UNA TARJETA DE REGALO <br><br>
                                  </font>
                              </td></tr><tr>
			</tr><tr>
                                <td valign="top">
                                  <font style="font-family:'HelveticaNeue',Arial,Helvetica,sans-serif;font-size:13px;line-height:18px;color:#000000">
                                    Hola <b> {{$dirigido_a}} </b> , Has recibido una tarjeta de regalo de parte de <b>{{$de_parte_de}}</b> para que puedas disfrutarlo en la academia <b>{{$academia}}</b> con sólo pulsar el siguiente link podrás acceder y ver tu regalo:
