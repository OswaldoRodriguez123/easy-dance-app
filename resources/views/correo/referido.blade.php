      ...
      <tbody><tr>
        <td valign="top">
          <table align="center" bgcolor="#efefef" border="0" cellpadding="0" cellspacing="0" width="600">
                        ...
                        <tbody><tr>
                          ...
                          <td valign="top" width="510">
                            <table border="0" cellpadding="0" cellspacing="0" width="510">
                              ...
                              <tr>
                                <td align="center" valign="top"><img class="CToWUd" alt="Pocket-logo-email-original" src="http://oi65.tinypic.com/20kviv6.jpg" height="300" width="570">
                                </td>
                              </tr>
                              <tr>
			...
			<tr>
                                <td valign="top" style="text-align:center;">
                                  <font style="font-family:'HelveticaNeue',Arial,Helvetica,sans-serif;font-size:16px;line-height:18px;color:#000000;font-weight:bold;"> ESPERO QUE TE UNAS A ESTA NUEVA EXPERIENCIA  <br><br>
                                  </font>
                              </td></tr><tr>
			</tr>                   <tr>
                                <td valign="top">
                              ...
                              <tr>
                                ...
                                <td style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:15px;font-weight:bold" align="center">
                                    ...
                                    <a href="http://tuclasedebaile.com.co/#/registro" style="background-color:#4E1E43;border-radius:2px;color:#ffffff;display:inline-block;line-height:40px;text-align:center;text-decoration:none;width:200px" target="_blank">Ingresa el código</a>
                                  </td>
                              </tr>
