...
<!--                               <tr>
			...
			<tr>
                                <td valign="top" style="text-align:center;">
                                  <font style="font-family:'HelveticaNeue',Arial,Helvetica,sans-serif;font-size:16px;line-height:18px;color:#000000;font-weight:bold;"> ESPERO QUE ASISTAS A LA FIESTA  <br><br>
                                  </font>
                              </td></tr><tr>
			</tr>                   <tr>
                                <td valign="top">
                                  <font style="font-family:'HelveticaNeue',Arial,Helvetica,sans-serif;font-size:13px;line-height:18px;color:#000000">
                                    ...
                                    Saludos <b>{{$nombre_destino}}</b>, has recibido este correo por que <b>{{$nombre_envio}}</b> te ha invitado a asistir a la fiesta <b>“{{$fiesta}}”</b> te invitamos a que veas de que se trata.
                                    </font>
                                </td>
                              ...
                              <tr>
                                ...
                                <td style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:15px;font-weight:bold" align="center">
                                  ...
                                  <a href="{{$link}}" style="background-color:#4E1E43;border-radius:2px;color:#ffffff;display:inline-block;line-height:40px;text-align:center;text-decoration:none;width:160px" target="_blank">Ver fiesta</a>
                                </td>
