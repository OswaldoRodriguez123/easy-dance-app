			...
			<tr>
                                ...
                                <td valign="top">
                                  <font style="font-family:'HelveticaNeue',Arial,Helvetica,sans-serif;font-size:13px;line-height:18px;color:#000000">
                                    Hola <b> {{$nombre}} </b> estamos muy contentos que te hayas unido a nuestra comunidad del baile tu cuenta ha sido creada.
                                    <p>Los datos para ingresar son los siguientes:</p>

                                    Nombre de usuario: {{$email}} <br/>
                                    Contraseña: {{$contrasena}} <br/><br/>

                                    Ahora sólo necesitas pulsar el enlace  para la verificación tu correo:</font>
                                </td>
                              </tr>
