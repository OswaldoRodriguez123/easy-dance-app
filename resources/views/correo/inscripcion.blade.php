			...
			<tr>
                                ...
                                <td valign="top">
                                  <font style="font-family:'HelveticaNeue',Arial,Helvetica,sans-serif;font-size:13px;line-height:18px;color:#000000">
                                    ...
                                    Somos una aplicación web exclusiva para las academias de baile y danza, a partir de ahora podrás recibir múltiples beneficios, sólo debes pulsar el enlace para ingresar a la aplicación.
