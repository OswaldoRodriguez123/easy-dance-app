...
<div bgcolor="#efefef" style="background:#efefef"><div class="adM">
      ...
      <tr>
                                <td valign="top" style="text-align:center;">
                                  <font style="font-family:'HelveticaNeue',Arial,Helvetica,sans-serif;font-size:16px;line-height:18px;color:#000000;font-weight:bold;"> ESTAMOS MUY FELICES CON TU CONTRIBUCIÓN <br><br>
                                  </font>
                              </td></tr><tr>
      </tr><tr>
                                <td valign="top">
                                  <font style="font-family:'HelveticaNeue',Arial,Helvetica,sans-serif;font-size:13px;line-height:18px;color:#000000">
                                    Hola <b>{{$nombre}}</b>, Estamos muy felices por el aporte que has realizado en pro a la fiesta <b>“{{$fiesta}}”</b> te has convertido en uno de nuestros  <a href="{{$link}}">“PATROCINADORES  ANGÉLES”</a> Has demostrado tener un gran corazón, ahora puedes invitar a otros amigos a sumarse a esta genial fiesta.
