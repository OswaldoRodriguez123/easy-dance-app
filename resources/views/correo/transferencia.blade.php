...
<div bgcolor="#efefef" style="background:#efefef"><div class="adM">
      ...
      <tr>
                                <td valign="top" style="text-align:center;">
                                  <font style="font-family:'HelveticaNeue',Arial,Helvetica,sans-serif;font-size:16px;line-height:18px;color:#000000;font-weight:bold;"> HAN REALIZADO UNA TRANSFERENCIA <br><br>
                                  </font>
                              </td></tr><tr>
      </tr><tr>
                                <td valign="top">
                                  <font style="font-family:'HelveticaNeue',Arial,Helvetica,sans-serif;font-size:13px;line-height:18px;color:#000000">
                                    El alumno <b>{{$nombre}}</b> ha realizado una transferencia al banco <b>{{$banco}}</b> con el numero de referencia <b>{{$referencia}}</b> por un monto de <b>{{ number_format($cantidad, 2, '.' , '.')}}</b> Comunicate con el para confirmar su pago.
