	...
	*/
	...
	Route::group(['middleware' => ['auth','verified'] ], function () {
		...
		Route::group(['middleware' => 'recepcionista'], function() {
			...
			Route::put('participante/instructor/update/password', 'InstructorController@updatePassword');
			...
			Route::get('proveedores', 'ProveedorController@principal');
			Route::post('proveedores/agregar', 'ProveedorController@store');
			Route::get('proveedores/agregar', 'ProveedorController@create');
			Route::delete('proveedores/eliminar/{id}', 'ProveedorController@destroy');
			Route::get('proveedores/detalle/{id}', 'ProveedorController@edit');
			Route::get('proveedores/operaciones/{id}', 'ProveedorController@operar');
			Route::put('proveedores/update/nombre','ProveedorController@updateNombre');
			Route::put('proveedores/update/fecha_nacimiento','ProveedorController@updateFecha');
			Route::put('proveedores/update/sexo','ProveedorController@updateSexo');
			Route::put('proveedores/update/correo','ProveedorController@updateCorreo');
			Route::put('proveedores/update/telefono','ProveedorController@updateTelefono');
			Route::put('proveedores/update/direccion','ProveedorController@updateDireccion');
			Route::put('proveedores/update/empresa','ProveedorController@updateEmpresa');

			//PAQUETES 

			Route::get('paquetes','PaqueteController@principal');
			Route::get('paquetes/agregar','PaqueteController@create');
			Route::post('paquetes/agregar','PaqueteController@store');
			Route::get('paquetes/detalle/{id}','PaqueteController@edit');
			Route::delete('paquetes/eliminar/{id}', 'PaqueteController@destroy');

			Route::put('paquetes/update/nombre', 'PaqueteController@updateNombre');
			Route::put('paquetes/update/costo', 'PaqueteController@updateCosto');
			Route::put('paquetes/update/cantidad', 'PaqueteController@updateCantidad');
			Route::put('paquetes/update/descripcion', 'PaqueteController@updateDescripcion');
			Route::put('paquetes/update/imagen', 'PaqueteController@updateImagen');
			Route::put('paquetes/update/dias', 'PaqueteController@updateDias');
			Route::put('paquetes/update/tipo', 'PaqueteController@updateTipo');

				// PRODUCTOS

			Route::get('productos','ConfigProductosController@principalproductos');
			Route::get('productos/agregar','ConfigProductosController@agregarproductos');
			Route::post('productos/agregar','ConfigProductosController@store');
			Route::get('productos/detalle/{id}', 'ConfigProductosController@edit');
			Route::delete('productos/eliminar/{id}', 'ConfigProductosController@destroy');

			Route::post('productos/agregar_cantidad','ConfigProductosController@agregar_cantidad');
			Route::post('productos/eliminar_cantidad/{id}', 'ConfigProductosController@eliminar_cantidad');

			Route::put('productos/update/nombre', 'ConfigProductosController@updateNombre');
			Route::put('productos/update/costo', 'ConfigProductosController@updateCosto');
			Route::put('productos/update/cantidad', 'ConfigProductosController@updateCantidad');
			Route::put('productos/update/descripcion', 'ConfigProductosController@updateDescripcion');
			...
			Route::get('servicios','ConfigServiciosController@principalservicios');
			Route::get('servicios/agregar','ConfigServiciosController@agregarservicios');
			Route::post('servicios/agregar','ConfigServiciosController@store');
			Route::get('servicios/detalle/{id}', 'ConfigServiciosController@edit');
			Route::delete('servicios/eliminar/{id}', 'ConfigServiciosController@destroy');

			Route::put('servicios/update/nombre', 'ConfigServiciosController@updateNombre');
			Route::put('servicios/update/costo', 'ConfigServiciosController@updateCosto');
			Route::put('servicios/update/descripcion', 'ConfigServiciosController@updateDescripcion');
			Route::put('servicios/update/opciones', 'ConfigServiciosController@updateOpciones');
			Route::put('servicios/update/impuesto', 'ConfigServiciosController@updateImpuesto');
			Route::put('servicios/update/imagen', 'ConfigServiciosController@updateImagen');
			Route::put('servicios/update/tipo', 'ConfigServiciosController@updateTipo');
		...
		Route::group(['middleware' => ['instructor']], function() {
			...
			Route::post('agendar/clases-grupales/consulta_examen/{id}', 'ClaseGrupalController@consulta_examen_clase_grupal');
