...
class ProgresoController extends BaseController {
    ...
    public function progreso($id)
    {
    	...
    	if($find){
	        ...
	        return view('progreso.progreso')->with(['clase_1' => $clase_1, 'clase_2' => $clase_2, 'clase_3' => $clase_3, 'clase_4' => $clase_4, 'clase_5' => $clase_5, 'clase_6' => $clase_6, 'clase_7' => $clase_7, 'clase_8' => $clase_8, 'clase_9' => $clase_9, 'clase_10' => $clase_10, 'clase_11' => $clase_11, 'clase_12' => $clase_12, 'clase_13' => $clase_13, 'clase_14' => $clase_14, 'clase_15' => $clase_15, 'clase_16' => $clase_16]);
    ...
    {
    	return view('progreso.programacion');
    }
