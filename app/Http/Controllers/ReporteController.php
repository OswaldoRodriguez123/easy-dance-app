...
class ReporteController extends BaseController
{
   ...
   public function Diagnosticos(){
        ...
        return view('reportes.diagnostico')->with(['clases_grupales' => $array, 'config_examenes' => $config_examenes, 'examenes' => $examenes]);
    }

    public function DiagnosticosFiltros(Request $request)
    {
        
        $query = Alumno::join('evaluaciones', 'evaluaciones.alumno_id', '=', 'alumnos.id')
    ...
    */    
    ...
    {
        $clase_grupal_join = ClaseGrupal::leftJoin('instructores', 'clases_grupales.instructor_id', '=', 'instructores.id')
            ->join('config_clases_grupales', 'clases_grupales.clase_grupal_id', '=', 'config_clases_grupales.id')
    ...
    public function Estatus_Alumnos()
    {
        ...
        return view('reportes.estatus_alumnos')->with(['alumnos' => $alumnos, 'clases_grupales' => $array]);
    }
    ...
    public function AdministrativoFiltros(Request $request)
    {
        ...
        if($request->tipo == 1 OR $request->tipo == 3){
            ...
            if($request->servicio_tipo == 0 || $request->servicio_tipo == 7){
                ...
                $nomina = PagoInstructor::leftJoin('instructores','pagos_instructor.instructor_id','=','instructores.id')
    ...
    public function Credenciales(){
        ...
        return view('reportes.credenciales')->with(['alumnos' => $alumnos, 'clases_grupales' => $array]);
    }
            ...
            if($clase_grupal){
                if($estatus != "c-rojo"){
                    if(!$clase_grupal->deleted_at){
                        ...
                        $fecha = Carbon::createFromFormat('Y-m-d H:i:s', $clase_grupal->deleted_at);
                        if($fecha >= $start && $fecha <= $end){
                            $alumno_array['fecha'] = $fecha->toDateString();
                            $array[] = $alumno_array;
                        }
